 ...
 */const D=(null==globalThis?void 0:globalThis.document)?b.useLayoutEffect:()=>{},I=b["useId".toString()]||(()=>void 0);let M=0;function z(e){let[t,n]=b.useState(I());// React versions older than 18 will have client-side ids only.
return D(()=>{e||n(e=>null!=e?e:String(M++))},[e]),e||(t?`radix-${t}`:"")}var b=m("bh6RR");// https://github.com/DefinitelyTyped/DefinitelyTyped/pull/55396
// prettier-ignore
/* -------------------------------------------------------------------------------------------------
 * Primitive
...
S:function(e,t){var n=t.length;return rI(Math.floor(e.getUTCMilliseconds()*Math.pow(10,n-3)),t.length)}},oP={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"};function o_(e,t){var n=e>0?"-":"+",r=Math.abs(e),o=Math.floor(r/60),i=r%60;return 0===i?n+String(o):n+String(o)+(t||"")+rI(i,2)}function oN(e,t){return e%60==0?(e>0?"-":"+")+rI(Math.abs(e)/60,2):oO(e,t)}function oO(e,t){var n=e>0?"-":"+",r=Math.abs(e);return n+rI(Math.floor(r/60),2)+(t||"")+rI(r%60,2)}var oA={// Era
...
// because the number of milliseconds in a week is not constant
// (e.g. it's different in the week of the daylight saving time clock shift)
return Math.round((oS(t).getTime()-(function(e){r_(1,arguments);var t=ok(e),n=new Date(0);return n.setUTCFullYear(t,0,4),n.setUTCHours(0,0,0,0),oS(n)})(t).getTime())/6048e5)+1}(e);return"Io"===t?n.ordinalNumber(r,{unit:"week"}):rI(r,t.length)},// Day of the month
d:function(e,t,n){return"do"===t?n.ordinalNumber(e.getUTCDate(),{unit:"date"}):oT.d(e,t)},// Day of year
D:function(e,t,n){var r=function(e){r_(1,arguments);var t=rN(e),n=t.getTime();return t.setUTCMonth(0,1),t.setUTCHours(0,0,0,0),Math.floor((n-t.getTime())/864e5)+1}(e);return"Do"===t?n.ordinalNumber(r,{unit:"dayOfYear"}):rI(r,t.length)},// Day of week
...
var R=rA(C),T=function(e,t){return r_(2,arguments),function(e,t){r_(2,arguments);var n=rN(e).getTime(),r=rT(t);return new Date(n+r)}(e,-rT(t))}(C,R),P={firstWeekContainsDate:k,weekStartsOn:E,locale:S,_originalDate:C};return x.match(oq).map(function(e){var t=e[0];return"p"===t||"P"===t?(0,oI[t])(e,S.formatLong):e}).join("").match(oB).map(function(r){// Replace two single quote characters with one single quote character
...
function aj(){let e=(0,b.useState)()[1],t=aA();return()=>{t.current&&e(Math.random())}}var aD=e=>(0,b.useEffect)(e,aI),aI=[];function aM(e){let t=(0,b.useRef)();return(0,b.useEffect)(()=>{t.current=e}),t.current}// src/Animated.ts
...
(0,b.useCallback)(e=>{i.current=(o&&(iN.fun(o)?o(e):o.current=e),e)},[o]),[l,s]=function(e,t){let n=/* @__PURE__ */new Set;return aG.dependencies=n,e.style&&(e={...e,style:t.createAnimatedStyle(e.style)}),e=new aB(e),aG.dependencies=null,[e,n]}(r,t),u=aj(),c=()=>{let e=i.current;if(n&&!e)return;let r=!!e&&t.applyAnimatedValues(e,l.getValue(!0));!1===r&&u()},d=new aX(c,s),f=(0,b.useRef)();aO(()=>(f.current=d,iA(s,e=>ah(e,d)),()=>{f.current&&(iA(f.current.deps,e=>am(e,f.current)),ic.cancel(f.current.update))})),(0,b.useEffect)(c,[]),aD(()=>()=>{let e=f.current;iA(e.deps,t=>am(t,e))});let p=t.getComponentProps(l.getValue());return /* @__PURE__ */b.createElement(e,{...p,ref:a})})},aX=class{constructor(e,t){this.update=e,this.deps=t}eventObserved(e){"change"==e.type&&ic.write(this.update)}},aJ=Symbol.for("AnimatedComponent"),aZ=e=>iN.str(e)?e:e&&iN.str(e.displayName)?e.displayName:iN.fun(e)&&e.name||null;function a0(e,...t){return iN.fun(e)?e(...t):e}var a1=(e,t)=>!0===e||!!(t&&e&&(iN.fun(e)?e(t):iD(e).includes(t))),a2=(e,t)=>iN.obj(e)?t&&e[t]:e,a3=(e,t)=>!0===e.default?e[t]:e.default?e.default[t]:void 0,a4=e=>e,a6=(e,t=a4)=>{let n=a5;e.default&&!0!==e.default&&(n=Object.keys(e=e.default));let r={};for(let o of n){let n=t(e[o],o);iN.und(n)||(r[o]=n)}return r},a5=["config","onProps","onStart","onChange","onPause","onResume","onRest"],a9={config:1,from:1,to:1,ref:1,loop:1,reset:1,pause:1,cancel:1,reverse:1,immediate:1,default:1,delay:1,onProps:1,onStart:1,onChange:1,onPause:1,onResume:1,onRest:1,onResolve:1,// Transition props
...
function(e){let t=sC(e),n=sI(e),r=e.ownerDocument.body,o=se(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),i=se(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),a=-n.scrollLeft+sH(e),l=-n.scrollTop;return"rtl"===sD(r).direction&&(a+=se(t.clientWidth,r.clientWidth)-o),{width:o,height:i,x:a,y:l}}(sC(e));else if(sT(t))r=// Returns the inner client rect, subtracting scrollbars if present.
function(e,t){let n=sV(e,!0,"fixed"===t),r=n.top+e.clientTop,o=n.left+e.clientLeft,i=sP(e)?sU(e):sr(1),a=e.clientWidth*i.x,l=e.clientHeight*i.y,s=o*i.x,u=r*i.y;return{width:a,height:l,x:s,y:u}}(t,n);else{let n=sW(e);r={...t,x:t.x-n.x,y:t.y-n.y}}return sm(r)}function sB(e,t){return sP(e)&&"fixed"!==sD(e).position?t?t(e):e.offsetParent:null}// Gets the closest ancestor positioned element. Handles some edge cases,
// such as table ancestors and cross browser bugs.
function sq(e,t){let n=sE(e);if(!sP(e))return n;let r=sB(e,t);for(;r&&["table","td","th"].includes(sk(r))&&"static"===sD(r).position;)r=sB(r,t);return r&&("html"===sk(r)||"body"===sk(r)&&"static"===sD(r).position&&!sO(r))?n:r||function(e){let t=sM(e);for(;sP(t)&&!sj(t);){if(sO(t))return t;t=sM(t)}return null}(e)||n}const sY=async function(e){let{reference:t,floating:n,strategy:r}=e,o=this.getOffsetParent||sq,i=this.getDimensions;return{reference:function(e,t,n){let r=sP(t),o=sC(t),i="fixed"===n,a=sV(e,!0,i,t),l={scrollLeft:0,scrollTop:0},s=sr(0);if(r||!r&&!i){if(("body"!==sk(t)||sN(o))&&(l=sI(t)),r){let e=sV(t,!0,i,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&(s.x=sH(o))}return{x:a.left+l.scrollLeft-s.x,y:a.top+l.scrollTop-s.y,width:a.width,height:a.height}}(t,await o(n),r),floating:{x:0,y:0,...await i(n)}}},sK={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:n,strategy:r}=e,o=sP(n),i=sC(n);if(n===i)return t;let a={scrollLeft:0,scrollTop:0},l=sr(1),s=sr(0);if((o||!o&&"fixed"!==r)&&(("body"!==sk(n)||sN(i))&&(a=sI(n)),sP(n))){let e=sV(n);l=sU(n),s.x=e.x+n.clientLeft,s.y=e.y+n.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-a.scrollLeft*l.x+s.x,y:t.y*l.y-a.scrollTop*l.y+s.y}},getDocumentElement:sC,getClippingRect:// Gets the maximum area that the element is visible in due to any number of
// clipping ancestors.
...
function(e,t){let n=t.get(e);if(n)return n;let r=sz(e,[],!1).filter(e=>sT(e)&&"body"!==sk(e)),o=null,i="fixed"===sD(e).position,a=i?sM(e):e;// https://developer.mozilla.org/en-US/docs/Web/CSS/Containing_block#identifying_the_containing_block
for(;sT(a)&&!sj(a);){let t=sD(a),n=sO(a);n||"fixed"!==t.position||(o=null);let l=i?!n&&!o:!n&&"static"===t.position&&!!o&&["absolute","fixed"].includes(o.position)||sN(a)&&!n&&function e(t,n){let r=sM(t);return!(r===n||!sT(r)||sj(r))&&("fixed"===sD(r).position||e(r,n))}(e,a);l?r=r.filter(e=>e!==a):o=t,a=sM(a)}return t.set(e,r),r}(t,this._c):[].concat(n),a=[...i,r],l=a[0],s=a.reduce((e,n)=>{let r=sG(t,n,o);return e.top=se(r.top,e.top),e.right=l7(r.right,e.right),e.bottom=l7(r.bottom,e.bottom),e.left=se(r.left,e.left),e},sG(t,l,o));return{width:s.right-s.left,height:s.bottom-s.top,x:s.left,y:s.top}},getOffsetParent:sq,getElementRects:sY,getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){return sL(e)},getScale:sU,isElement:sT,isRTL:function(e){return"rtl"===sD(e).direction}},sQ=(e,t,n)=>{// This caches the expensive `getClippingElementAncestors` function so that
...
i.onAnchorChange((null==r?void 0:r.current)||a.current)}),r?null:/*#__PURE__*/(0,b.createElement)(L.div,E({},o,{ref:l}))}),ue="PopperContent",[ut,un]=s6(ue),ur=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{var n,r,o,i,a,l,s,u,c,d,f,p,h,m;let{__scopePopper:g,side:y="bottom",sideOffset:w=0,align:x="center",alignOffset:S=0,arrowPadding:k=0,avoidCollisions:C=!0,collisionBoundary:R=[],collisionPadding:T=0,sticky:_="partial",hideWhenDetached:N=!1,updatePositionStrategy:O="optimized",onPlaced:A,...j}=e,I=s8(ue,g),[M,z]=(0,b.useState)(null),F=P(t,e=>z(e)),[$,W]=(0,b.useState)(null),V=function(e){let[t,n]=(0,b.useState)(void 0);return D(()=>{if(e){// provide size as early as possible
...
const fD=({days:e,hours:t,minutes:n,seconds:r,completed:o})=>{//ChatGPT Assisted
// Render a countdown
 ...
 */function h5(e){var t={};for(var n in e)t[0===n.indexOf("--")?n:h6(n)]=e[n];return e.fallbacks&&(Array.isArray(e.fallbacks)?t.fallbacks=e.fallbacks.map(h5):t.fallbacks=h5(e.fallbacks)),t}var h9=hI&&CSS?CSS.px:"px",h8=hI&&CSS?CSS.ms:"ms",h7=hI&&CSS?CSS.percent:"%";/**
 ...
 * @api public
 */function mD(e,t){// For server-side rendering.
...
try{u.style[e]=""}catch(e){return!1}return mO[e]}var mI={},mM={transition:1,"transition-property":1,"-webkit-transition":1,"-webkit-transition-property":1},mz=/(^\s*[\w-]+)|, (\s*[\w-]+)(?![^()]*\))/g;/**
 ...
 * @return {String}
 * @api private
 */function mL(e,t,n){return"var"===t?"var":"all"===t?"all":"all"===n?", all":(t?mD(t):", "+mD(n))||t||n}/**
 ...
 */function(e){return!!gj&&gj in e};var gD={},gI=Function.prototype.toString;gD=/**
 * Converts `func` to its source code.
 *
 * @private
 * @param {Function} func The function to convert.
 * @returns {string} Returns the source code.
 */function(e){if(null!=e){try{return gI.call(e)}catch(e){}try{return e+""}catch(e){}}return""};/** Used to detect host constructors (Safari). */var gM=/^\[object .+?Constructor\]$/,gz=Object.prototype,gL=Function.prototype.toString,gF=gz.hasOwnProperty,gU=RegExp("^"+gL.call(gF).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");gN=/**
 ...
 *  else `false`.
 */function(e){return!(!f8(e)||gO(e))&&(fQ(e)?gU:gM).test(gD(e))};var g$={};g$=/**
 ...
 */function(e){return function(t){return e(t)}};var vj=m("1mm29"),vD=vj&&vj.isTypedArray;v_=vD?vA(vD):vN;/** Used to check objects for own properties. */var vI=Object.prototype.hasOwnProperty;vx=/**
 ...
 */function(e,t){var n=go(e),r=!n&&vk(e),o=!n&&!r&&vP(e),i=!n&&!r&&!o&&v_(e),a=n||r||o||i,l=a?vS(e.length,String):[],s=l.length;for(var u in e)(t||vI.call(e,u))&&!(a&&// Safari 9 has enumerable `arguments.length` in strict mode.
...
y!=b&&"constructor"in e&&"constructor"in t&&!("function"==typeof y&&y instanceof y&&"function"==typeof b&&b instanceof b)&&(p=!1)}return i.delete(e),i.delete(t),p};var vW={},vV={},fZ=m("dnnhb");vV=g_(fZ,"DataView");var vH={},fZ=m("dnnhb");vH=g_(fZ,"Promise");var vG={},fZ=m("dnnhb");vG=g_(fZ,"Set");var vB={},fZ=m("dnnhb");vB=g_(fZ,"WeakMap");/** `Object#toString` result references. */var vq="[object Map]",vY="[object Promise]",vK="[object Set]",vQ="[object WeakMap]",vX="[object DataView]",vJ=gD(vV),vZ=gD(gP),v0=gD(vH),v1=gD(vG),v2=gD(vB),v3=fX;(vV&&v3(new vV(new ArrayBuffer(1)))!=vX||gP&&v3(new gP)!=vq||vH&&v3(vH.resolve())!=vY||vG&&v3(new vG)!=vK||vB&&v3(new vB)!=vQ)&&(v3=function(e){var t=fX(e),n="[object Object]"==t?e.constructor:void 0,r=n?gD(n):"";if(r)switch(r){case vJ:return vX;case vZ:return vq;case v0:return vY;case v1:return vK;case v2:return vQ}return t}),vW=v3;var vP=m("8TKuU"),v4="[object Arguments]",v6="[object Array]",v5="[object Object]",v9=Object.prototype.hasOwnProperty;gf=/**
...
,style:{position:"fixed"},onFocus:e=>{var t;let n=e.relatedTarget,o=!(null!==(t=i.viewport)&&void 0!==t&&t.contains(n));o&&r()}}))}),yj="Toast",yD=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{let{forceMount:n,open:r,defaultOpen:o,onOpenChange:i,...a}=e,[l=!0,s]=$({prop:r,defaultProp:o,onChange:i});return/*#__PURE__*/(0,b.createElement)(ei,{present:n||l},/*#__PURE__*/(0,b.createElement)(yz,E({open:l},a,{ref:t,onClose:()=>s(!1),onPause:U(e.onPause),onResume:U(e.onResume),onSwipeStart:C(e.onSwipeStart,e=>{e.currentTarget.setAttribute("data-swipe","start")}),onSwipeMove:C(e.onSwipeMove,e=>{let{x:t,y:n}=e.detail.delta;e.currentTarget.setAttribute("data-swipe","move"),e.currentTarget.style.setProperty("--radix-toast-swipe-move-x",`${t}px`),e.currentTarget.style.setProperty("--radix-toast-swipe-move-y",`${n}px`)}),onSwipeCancel:C(e.onSwipeCancel,e=>{e.currentTarget.setAttribute("data-swipe","cancel"),e.currentTarget.style.removeProperty("--radix-toast-swipe-move-x"),e.currentTarget.style.removeProperty("--radix-toast-swipe-move-y"),e.currentTarget.style.removeProperty("--radix-toast-swipe-end-x"),e.currentTarget.style.removeProperty("--radix-toast-swipe-end-y")}),onSwipeEnd:C(e.onSwipeEnd,e=>{let{x:t,y:n}=e.detail.delta;e.currentTarget.setAttribute("data-swipe","end"),e.currentTarget.style.removeProperty("--radix-toast-swipe-move-x"),e.currentTarget.style.removeProperty("--radix-toast-swipe-move-y"),e.currentTarget.style.setProperty("--radix-toast-swipe-end-x",`${t}px`),e.currentTarget.style.setProperty("--radix-toast-swipe-end-y",`${n}px`),s(!1)})})))}),[yI,yM]=yk(yj,{onClose(){}}),yz=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{let{__scopeToast:n,type:r="foreground",duration:o,open:i,onClose:a,onEscapeKeyDown:l,onPause:s,onResume:u,onSwipeStart:c,onSwipeMove:d,onSwipeCancel:f,onSwipeEnd:p,...h}=e,m=yR(yj,n),[g,y]=(0,b.useState)(null),w=P(t,e=>y(e)),x=(0,b.useRef)(null),S=(0,b.useRef)(null),k=o||m.duration,R=(0,b.useRef)(0),T=(0,b.useRef)(k),_=(0,b.useRef)(0),{onToastAdd:N,onToastRemove:O}=m,A=U(()=>{var e;// focus viewport if focus is within toast to read the remaining toast
...
(0,b.useEffect)(()=>{i&&!m.isClosePausedRef.current&&j(k)},[i,k,m.isClosePausedRef,j]),(0,b.useEffect)(()=>(N(),()=>O()),[N,O]);let D=(0,b.useMemo)(()=>g?function e(t){let n=[],r=Array.from(t.childNodes);// This allows SR VO to naturally pause break between nodes while announcing.
    return r.forEach(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent&&n.push(t.textContent),t.nodeType===t.ELEMENT_NODE){let r=t.ariaHidden||t.hidden||"none"===t.style.display,o=""===t.dataset.radixToastAnnounceExclude;if(!r){if(o){let e=t.dataset.radixToastAnnounceAlt;e&&n.push(e)}else n.push(...e(t))}}}),n}(g):null,[g]);return m.viewport?/*#__PURE__*/(0,b.createElement)(b.Fragment,null,D&&/*#__PURE__*/(0,b.createElement)(yL,{__scopeToast:n// Toasts are always role=status to avoid stuttering issues with role=alert in SRs.
,role:"status","aria-live":"foreground"===r?"assertive":"polite","aria-atomic":!0},D),/*#__PURE__*/(0,b.createElement)(yI,{scope:n,onClose:A},/*#__PURE__*/(0,v.createPortal)(/*#__PURE__*/(0,b.createElement)(yw.ItemSlot,{scope:n},/*#__PURE__*/(0,b.createElement)(t$,{asChild:!0,onEscapeKeyDown:C(l,()=>{m.isFocusedToastEscapeKeyDownRef.current||A(),m.isFocusedToastEscapeKeyDownRef.current=!1})},/*#__PURE__*/(0,b.createElement)(L.li,E({// Ensure toasts are announced as status list or status when focused
