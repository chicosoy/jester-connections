...
],[[f,Y],[u,Y],[d,y]],[/\b(android tv|smart[- ]?tv|opera tv|tv; rv:)\b/i// SmartTV from Unidentified Vendors
],[[d,y]],[///////////////////
// CONSOLES
///////////////////
...
setTimeout(()=>{let t=new CustomEvent(tY,tH);l.addEventListener(tY,c),l.dispatchEvent(t),t.defaultPrevented||tK(null!=e?e:document.body,{select:!0}),// we need to remove the listener after we `dispatchEvent`
l.removeEventListener(tY,c),tX.remove(p)},0)}}},[l,u,c,p]);let h=(0,y.useCallback)(e=>{if(!n&&!r||p.paused)return;let t="Tab"===e.key&&!e.altKey&&!e.ctrlKey&&!e.metaKey,o=document.activeElement;if(t&&o){let t=e.currentTarget,[r,i]=/**
...
function r$(e,t){var n=e.getFullYear()-t.getFullYear()||e.getMonth()-t.getMonth()||e.getDate()-t.getDate()||e.getHours()-t.getHours()||e.getMinutes()-t.getMinutes()||e.getSeconds()-t.getSeconds()||e.getMilliseconds()-t.getMilliseconds();return n<0?-1:n>0?1:n}function rU(e,t){for(var n=Math.abs(e).toString();n.length<t;)n="0"+n;return(e<0?"-":"")+n}var rV={dateTimeDelimiter:/[T ]/,timeZoneDelimiter:/[Z ]/i,timezone:/([Z+-].*)$/},rW=/^-?(?:(\d{3})|(\d{2})(?:-?(\d{2}))?|W(\d{2})(?:-?(\d{1}))?|)$/,rB=/^(\d{2}(?:[.,]\d*)?)(?::?(\d{2}(?:[.,]\d*)?))?(?::?(\d{2}(?:[.,]\d*)?))?$/,rY=/^([+-])(\d{2})(?::?(\d{2}))?$/;function rH(e){return e?parseInt(e):1}function rG(e){return e&&parseFloat(e.replace(",","."))||0}// Validation functions
...
_start(){let e=this.animation;i6(this).reset(iN(e.to)),e.immediate||(e.fromValues=e.values.map(e=>e.lastPosition)),aU(this)||(aW(this,!0),aV(this)||this._resume())}_resume(){oR.skipAnimation?this.finish():it.start(this)}/**
   ...
   */_stop(e,t){if(aU(this)){aW(this,!1);let n=this.animation;oX(n.values,e=>{e.done=!0}),n.toValues&&(n.onChange=n.onPause=n.onResume=void 0),ij(this,{type:"idle",parent:this});let r=t?aO(this.get()):aN(this.get(),aH(this,e??n.to));o1(this._pendingCalls,r),n.changed&&(n.changed=!1,aZ(this,"onRest",r,this))}}};function aH(e,t){let n=aw(t),r=aw(e.get());return oK(r,n)}function aG(e,t=e.loop,n=e.to){let r=ad(t);if(r){let o=!0!==r&&ab(r),i=(o||e).reverse,a=!o||o.reset;return aq({...e,loop:t,// Avoid updating default props when looping.
...
// Derivable.
async function lW(e,t){let{placement:n,platform:r,elements:o}=e,i=await (null==r.isRTL?void 0:r.isRTL(o.floating)),a=lR(n),l=lT(n),s="y"===lj(n),u=["left","top"].includes(a)?-1:1,c=i&&s?-1:1,d=lP(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:h}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...d};return l&&"number"==typeof h&&(p="end"===l?-1*h:h),s?{x:p*c,y:f*u}:{x:f*u,y:p*c}}function lB(e){return lG(e)?(e.nodeName||"").toLowerCase():"#document"}function lY(e){var t;return(null==e?void 0:null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function lH(e){var t;return null==(t=(lG(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function lG(e){return e instanceof Node||e instanceof lY(e).Node}function lq(e){return e instanceof Element||e instanceof lY(e).Element}function lQ(e){return e instanceof HTMLElement||e instanceof lY(e).HTMLElement}function lK(e){return(// Browsers without `ShadowRoot` support.
"undefined"!=typeof ShadowRoot&&(e instanceof ShadowRoot||e instanceof lY(e).ShadowRoot))}function lX(e){let{overflow:t,overflowX:n,overflowY:r,display:o}=l1(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&!["inline","contents"].includes(o)}function lZ(e){let t=lJ(),n=l1(e);// https://developer.mozilla.org/en-US/docs/Web/CSS/Containing_block#identifying_the_containing_block
return"none"!==n.transform||"none"!==n.perspective||!!n.containerType&&"normal"!==n.containerType||!t&&!!n.backdropFilter&&"none"!==n.backdropFilter||!t&&!!n.filter&&"none"!==n.filter||["transform","perspective","filter"].some(e=>(n.willChange||"").includes(e))||["paint","layout","strict","content"].some(e=>(n.contain||"").includes(e))}function lJ(){return"undefined"!=typeof CSS&&!!CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")}function l0(e){return["html","body","#document"].includes(lB(e))}function l1(e){return lY(e).getComputedStyle(e)}function l2(e){return lq(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}}function l3(e){if("html"===lB(e))return e;let t=e.assignedSlot||// DOM Element detected.
e.parentNode||// ShadowRoot detected.
lK(e)&&e.host||// Fallback.
lH(e);return lK(t)?t.host:t}function l4(e,t,n){var r;void 0===t&&(t=[]),void 0===n&&(n=!0);let o=function e(t){let n=l3(t);return l0(n)?t.ownerDocument?t.ownerDocument.body:t.body:lQ(n)&&lX(n)?n:e(n)}(e),i=o===(null==(r=e.ownerDocument)?void 0:r.body),a=lY(o);return i?t.concat(a,a.visualViewport||[],lX(o)?o:[],a.frameElement&&n?l4(a.frameElement):[]):t.concat(o,l4(o,[],n))}function l5(e){let t=l1(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,o=lQ(e),i=o?e.offsetWidth:n,a=o?e.offsetHeight:r,l=lk(n)!==i||lk(r)!==a;return l&&(n=i,r=a),{width:n,height:r,$:l}}function l6(e){return lq(e)?e:e.contextElement}function l8(e){let t=l6(e);if(!lQ(t))return lE(1);let n=t.getBoundingClientRect(),{width:r,height:o,$:i}=l5(t),a=(i?lk(n.width):n.width)/r,l=(i?lk(n.height):n.height)/o;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}let l9=lE(0);function l7(e){let t=lY(e);return lJ()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:l9}function se(e,t,n,r){var o;void 0===t&&(t=!1),void 0===n&&(n=!1);let i=e.getBoundingClientRect(),a=l6(e),l=lE(1);t&&(r?lq(r)&&(l=l8(r)):l=l8(e));let s=(void 0===(o=n)&&(o=!1),r&&(!o||r===lY(a))&&o)?l7(a):lE(0),u=(i.left+s.x)/l.x,c=(i.top+s.y)/l.y,d=i.width/l.x,f=i.height/l.y;if(a){let e=lY(a),t=r&&lq(r)?lY(r):r,n=e.frameElement;for(;n&&r&&t!==e;){let e=l8(n),t=n.getBoundingClientRect(),r=l1(n),o=t.left+(n.clientLeft+parseFloat(r.paddingLeft))*e.x,i=t.top+(n.clientTop+parseFloat(r.paddingTop))*e.y;u*=e.x,c*=e.y,d*=e.x,f*=e.y,u+=o,c+=i,n=lY(n).frameElement}}return lI({width:d,height:f,x:u,y:c})}function st(e){// If <html> has a CSS width greater than the viewport, then this will be
// incorrect for RTL.
return se(lH(e)).left+l2(e).scrollLeft}function sn(e,t,n){let r;if("viewport"===t)r=function(e,t){let n=lY(e),r=lH(e),o=n.visualViewport,i=r.clientWidth,a=r.clientHeight,l=0,s=0;if(o){i=o.width,a=o.height;let e=lJ();(!e||e&&"fixed"===t)&&(l=o.offsetLeft,s=o.offsetTop)}return{width:i,height:a,x:l,y:s}}(e,n);else if("document"===t)r=// Gets the entire size of the scrollable document area, even extending outside
// of the `<html>` and `<body>` rect bounds if horizontally scrollable.
function(e){let t=lH(e),n=l2(e),r=e.ownerDocument.body,o=lx(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),i=lx(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),a=-n.scrollLeft+st(e),l=-n.scrollTop;return"rtl"===l1(r).direction&&(a+=lx(t.clientWidth,r.clientWidth)-o),{width:o,height:i,x:a,y:l}}(lH(e));else if(lq(t))r=// Returns the inner client rect, subtracting scrollbars if present.
...
function so(e,t){let n=lY(e);if(!lQ(e))return n;let r=sr(e,t);for(;r&&["table","td","th"].includes(lB(r))&&"static"===l1(r).position;)r=sr(r,t);return r&&("html"===lB(r)||"body"===lB(r)&&"static"===l1(r).position&&!lZ(r))?n:r||function(e){let t=l3(e);for(;lQ(t)&&!l0(t);){if(lZ(t))return t;t=l3(t)}return null}(e)||n}let si=async function(e){let{reference:t,floating:n,strategy:r}=e,o=this.getOffsetParent||so,i=this.getDimensions;return{reference:function(e,t,n){let r=lQ(t),o=lH(t),i="fixed"===n,a=se(e,!0,i,t),l={scrollLeft:0,scrollTop:0},s=lE(0);if(r||!r&&!i){if(("body"!==lB(t)||lX(o))&&(l=l2(t)),r){let e=se(t,!0,i,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&(s.x=st(o))}return{x:a.left+l.scrollLeft-s.x,y:a.top+l.scrollTop-s.y,width:a.width,height:a.height}}(t,await o(n),r),floating:{x:0,y:0,...await i(n)}}},sa={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:n,strategy:r}=e,o=lQ(n),i=lH(n);if(n===i)return t;let a={scrollLeft:0,scrollTop:0},l=lE(1),s=lE(0);if((o||!o&&"fixed"!==r)&&(("body"!==lB(n)||lX(i))&&(a=l2(n)),lQ(n))){let e=se(n);l=l8(n),s.x=e.x+n.clientLeft,s.y=e.y+n.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-a.scrollLeft*l.x+s.x,y:t.y*l.y-a.scrollTop*l.y+s.y}},getDocumentElement:lH,getClippingRect:// Gets the maximum area that the element is visible in due to any number of
// clipping ancestors.
...
r=e.offsetWidth,o=e.offsetHeight;n({width:r,height:o})});return t.observe(e,{box:"border-box"}),()=>t.unobserve(e)}n(void 0)},[e]),t}(U),B=null!==(n=null==W?void 0:W.width)&&void 0!==n?n:0,Y=null!==(r=null==W?void 0:W.height)&&void 0!==r?r:0,H="number"==typeof R?R:{top:0,right:0,bottom:0,left:0,...R},G=Array.isArray(_)?_:[_],q=G.length>0,Q={padding:H,boundary:G.filter(s_),// with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
...
return!1}return!0},pY=function(e,t){try{// Support CSSTOM.
e.attributeStyleMap?e.attributeStyleMap.delete(t):e.style.removeProperty(t)}catch(e){}},pH=function(e,t){// Currently works in chrome only.
 ...
 * @return {String}
 * @api private
 */function hY(e){return hB("-"+e)}var hH={"flex-grow":"flex-positive","flex-shrink":"flex-negative","flex-basis":"flex-preferred-size","justify-content":"flex-pack",order:"flex-order","align-items":"flex-align","align-content":"flex-line-pack"// 'align-self' is handled by 'align-self' plugin.
},hG={flex:"box-flex","flex-grow":"box-flex","flex-direction":["box-orient","box-direction"],order:"box-ordinal-group","align-items":"box-align","flex-flow":["box-orient","box-direction"],"justify-content":"box-pack"},hq=Object.keys(hG),hQ=function(e){return hU.css+e},hK=[{noPrefill:["appearance"],supportedProperty:function(e){return"appearance"===e&&("ms"===hU.js?"-webkit-"+e:hU.css+e)}},{noPrefill:["color-adjust"],supportedProperty:function(e){return"color-adjust"===e&&("Webkit"===hU.js?hU.css+"print-"+e:e)}},{noPrefill:["mask"],supportedProperty:function(e,t){if(!/^mask/.test(e))return!1;if("Webkit"===hU.js){var n="mask-image";if(hB(n) in t)return e;if(hU.js+hY(n) in t)return hU.css+e}return e}},{noPrefill:["text-orientation"],supportedProperty:function(e){return"text-orientation"===e&&("apple"!==hU.vendor||hU.isTouch?e:hU.css+e)}},{noPrefill:["transform"],supportedProperty:function(e,t,n){return"transform"===e&&(n.transform?e:hU.css+e)}},{noPrefill:["transition"],supportedProperty:function(e,t,n){return"transition"===e&&(n.transition?e:hU.css+e)}},{noPrefill:["writing-mode"],supportedProperty:function(e){return"writing-mode"===e&&("Webkit"===hU.js||"ms"===hU.js&&"edge"!==hU.browser?hU.css+e:e)}},{noPrefill:["user-select"],supportedProperty:function(e){return"user-select"===e&&("Moz"===hU.js||"ms"===hU.js||"apple"===hU.vendor?hU.css+e:e)}},{supportedProperty:function(e,t){return!!/^break-/.test(e)&&("Webkit"===hU.js?"WebkitColumn"+hY(e) in t&&hU.css+"column-"+e:"Moz"===hU.js&&"page"+hY(e) in t&&"page-"+e)}},{supportedProperty:function(e,t){if(!/^(border|margin|padding)-inline/.test(e))return!1;if("Moz"===hU.js)return e;var n=e.replace("-inline","");return hU.js+hY(n) in t&&hU.css+n}},{supportedProperty:function(e,t){return hB(e) in t&&e}},{supportedProperty:function(e,t){var n=hY(e);// Return custom CSS variable without prefixing.
...
mB.prototype.clear=mz,mB.prototype.delete=mF,mB.prototype.get=mU,mB.prototype.has=mV,mB.prototype.set=mW,mI=mB;var mY={};mY=/**
 * Removes all key-value entries from the stack.
 *
 * @private
 * @name clear
 * @memberOf Stack
 */function(){this.__data__=new mI,this.size=0};var mH={};mH=/**
...
gb.prototype.clear=mY,gb.prototype.delete=mH,gb.prototype.get=mG,gb.prototype.has=mq,gb.prototype.set=mQ,mD=gb;var gw={},gx={},gk={};gk=/**
 ...
 */function(e,t){var n=m_(e),r=!n&&gY(e),o=!n&&!r&&gK(e),i=!n&&!r&&!o&&gX(e),a=n||r||o||i,l=a?gB(e.length,String):[],s=l.length;for(var u in e)(t||g3.call(e,u))&&!(a&&// Safari 9 has enumerable `arguments.length` in strict mode.
