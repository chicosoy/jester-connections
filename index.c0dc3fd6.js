 ...
 * Dialog
 * -----------------------------------------------------------------------------------------------*/let nD="Dialog",[nI,nz]=T(nD),[nL,nF]=nI(nD),nU=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{let{__scopeDialog:n,...r}=e,o=nF("DialogTrigger",n),i=_(t,o.triggerRef);return/*#__PURE__*/(0,b.createElement)(L.button,E({type:"button","aria-haspopup":"dialog","aria-expanded":o.open,"aria-controls":o.contentId,"data-state":n2(o.open)},r,{ref:i,onClick:C(e.onClick,o.onOpenToggle)}))}),n$="DialogPortal",[nW,nV]=nI(n$,{forceMount:void 0}),nH="DialogOverlay",nG=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{let n=nV(nH,e.__scopeDialog),{forceMount:r=n.forceMount,...o}=e,i=nF(nH,e.__scopeDialog);return i.modal?/*#__PURE__*/(0,b.createElement)(ei,{present:r||i.open},/*#__PURE__*/(0,b.createElement)(nY,E({},o,{ref:t}))):null}),nY=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{let{__scopeDialog:n,...r}=e,o=nF(nH,n);return/*#__PURE__*/(0,b.createElement)(nP,{as:N,allowPinchZoom:!0,shards:[o.contentRef]},/*#__PURE__*/(0,b.createElement)(L.div,E({"data-state":n2(o.open)},r,{ref:t// We re-enable pointer-events prevented by `Dialog.Content` to allow scrolling the overlay.
...
S:function(e,t){var n=t.length;return rD(Math.floor(e.getUTCMilliseconds()*Math.pow(10,n-3)),t.length)}},o_={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"};function oN(e,t){var n=e>0?"-":"+",r=Math.abs(e),o=Math.floor(r/60),i=r%60;return 0===i?n+String(o):n+String(o)+(t||"")+rD(i,2)}function oR(e,t){return e%60==0?(e>0?"-":"+")+rD(Math.abs(e)/60,2):oO(e,t)}function oO(e,t){var n=e>0?"-":"+",r=Math.abs(e);return n+rD(Math.floor(r/60),2)+(t||"")+rD(r%60,2)}var oA={// Era
...
// because the number of milliseconds in a week is not constant
// (e.g. it's different in the week of the daylight saving time clock shift)
return Math.round((oS(t).getTime()-(function(e){rN(1,arguments);var t=ok(e),n=new Date(0);return n.setUTCFullYear(t,0,4),n.setUTCHours(0,0,0,0),oS(n)})(t).getTime())/6048e5)+1}(e);return"Io"===t?n.ordinalNumber(r,{unit:"week"}):rD(r,t.length)},// Day of the month
d:function(e,t,n){return"do"===t?n.ordinalNumber(e.getUTCDate(),{unit:"date"}):oP.d(e,t)},// Day of year
D:function(e,t,n){var r=function(e){rN(1,arguments);var t=rR(e),n=t.getTime();return t.setUTCMonth(0,1),t.setUTCHours(0,0,0,0),Math.floor((n-t.getTime())/864e5)+1}(e);return"Do"===t?n.ordinalNumber(r,{unit:"dayOfYear"}):rD(r,t.length)},// Day of week
...
function sB(e,t){let n=sE(e);if(!s_(e))return n;let r=sY(e,t);for(;r&&["table","td","th"].includes(sk(r))&&"static"===sj(r).position;)r=sY(r,t);return r&&("html"===sk(r)||"body"===sk(r)&&"static"===sj(r).position&&!sO(r))?n:r||function(e){let t=sI(e);for(;s_(t)&&!sM(t);){if(sO(t))return t;t=sI(t)}return null}(e)||n}let sq=async function(e){let{reference:t,floating:n,strategy:r}=e,o=this.getOffsetParent||sB,i=this.getDimensions;return{reference:function(e,t,n){let r=s_(t),o=sC(t),i="fixed"===n,a=sV(e,!0,i,t),l={scrollLeft:0,scrollTop:0},s=sr(0);if(r||!r&&!i){if(("body"!==sk(t)||sR(o))&&(l=sD(t)),r){let e=sV(t,!0,i,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&(s.x=sH(o))}return{x:a.left+l.scrollLeft-s.x,y:a.top+l.scrollTop-s.y,width:a.width,height:a.height}}(t,await o(n),r),floating:{x:0,y:0,...await i(n)}}},sK={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:n,strategy:r}=e,o=s_(n),i=sC(n);if(n===i)return t;let a={scrollLeft:0,scrollTop:0},l=sr(1),s=sr(0);if((o||!o&&"fixed"!==r)&&(("body"!==sk(n)||sR(i))&&(a=sD(n)),s_(n))){let e=sV(n);l=sU(n),s.x=e.x+n.clientLeft,s.y=e.y+n.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-a.scrollLeft*l.x+s.x,y:t.y*l.y-a.scrollTop*l.y+s.y}},getDocumentElement:sC,getClippingRect:// Gets the maximum area that the element is visible in due to any number of
// clipping ancestors.
...
for(;sP(a)&&!sM(a);){let t=sj(a),n=sO(a);n||"fixed"!==t.position||(o=null);let l=i?!n&&!o:!n&&"static"===t.position&&!!o&&["absolute","fixed"].includes(o.position)||sR(a)&&!n&&function e(t,n){let r=sI(t);return!(r===n||!sP(r)||sM(r))&&("fixed"===sj(r).position||e(r,n))}(e,a);l?r=r.filter(e=>e!==a):o=t,a=sI(a)}return t.set(e,r),r}(t,this._c):[].concat(n),a=[...i,r],l=a[0],s=a.reduce((e,n)=>{let r=sG(t,n,o);return e.top=se(r.top,e.top),e.right=l7(r.right,e.right),e.bottom=l7(r.bottom,e.bottom),e.left=se(r.left,e.left),e},sG(t,l,o));return{width:s.right-s.left,height:s.bottom-s.top,x:s.left,y:s.top}},getOffsetParent:sB,getElementRects:sq,getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){return sL(e)},getScale:sU,isElement:sP,isRTL:function(e){return"rtl"===sj(e).direction}},sQ=(e,t,n)=>{// This caches the expensive `getClippingElementAncestors` function so that
...
if(mI[e])n=n.replace(mz,mL);else if(""===c.style[e]&&("-ms-flex"===// Value with a vendor prefix.
 ...
 */function(e){if(null!=e){try{return gD.call(e)}catch(e){}try{return e+""}catch(e){}}return""};/** Used to detect host constructors (Safari). */var gI=/^\[object .+?Constructor\]$/,gz=Object.prototype,gL=Function.prototype.toString,gF=gz.hasOwnProperty,gU=RegExp("^"+gL.call(gF).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");gR=/**
 ...
 *  else `false`.
 */function(e){return!(!f9(e)||gO(e))&&(fQ(e)?gU:gI).test(gj(e))};var g$={};g$=/**
 ...
 */function(e){return function(t){return e(t)}};var vM=m("7vc1R"),vj=vM&&vM.isTypedArray;vN=vj?vA(vj):vR;/** Used to check objects for own properties. */var vD=Object.prototype.hasOwnProperty;vx=/**
 ...
 */function(e,t){var n=go(e),r=!n&&vk(e),o=!n&&!r&&v_(e),i=!n&&!r&&!o&&vN(e),a=n||r||o||i,l=a?vS(e.length,String):[],s=l.length;for(var u in e)(t||vD.call(e,u))&&!(a&&// Safari 9 has enumerable `arguments.length` in strict mode.
...
pe(u,s)))&&l.push(u);return l};var vI={},vz={},vL=Object.prototype;vz=/**
 * Checks if `value` is likely a prototype object.
 *
 * @private
 * @param {*} value The value to check.
 * @returns {boolean} Returns `true` if `value` is a prototype, else `false`.
 */function(e){var t=e&&e.constructor;return e===("function"==typeof t&&t.prototype||vL)};var vF={};i=Object.keys,a=Object,vF=function(e){return i(a(e))};/** Used to check objects for own properties. */var vU=Object.prototype.hasOwnProperty;vI=/**
 ...
 * _.keys('hi');
 * // => ['0', '1']
 */function(e){return fK(e)?vx(e):vI(e)},vf=/**
