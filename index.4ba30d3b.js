...
console.warn(Error().stack)),new Date(NaN)))}function rM(e){rI(1,arguments);var t=rD(e);return t.setHours(0,0,0,0),t}/**
...
return 0===l?0:l}(t,os)%1;return r$(t,-n)},oc=e=>r$(ou(e),1),od=e=>{let t=os;console.log("start ",t),console.log("today ",e);let n=-1;console.log(os);do n++,t=r$(t,1);while(t<=e)return n},of=e=>{if(e<0)throw Error("Invalid index");return oa[e%oa.length]},op=e=>{try{if(e<ol()){window.location.href="/?d="+function(e,t){rI(1,arguments);var n,r,o=rD(e);if(isNaN(o.getTime()))throw RangeError("Invalid time value");var i=String(null!==(n=null==t?void 0:t.format)&&void 0!==n?n:"extended"),a=String(null!==(r=null==t?void 0:t.representation)&&void 0!==r?r:"complete");if("extended"!==i&&"basic"!==i)throw RangeError("format must be 'extended' or 'basic'");if("date"!==a&&"time"!==a&&"complete"!==a)throw RangeError("representation must be 'date', 'time', or 'complete'");var l="",s="",u="extended"===i?"-":"";// Representation is either 'date' or 'complete'
if("time"!==a){var c=rQ(o.getDate(),2),d=rQ(o.getMonth()+1,2),f=rQ(o.getFullYear(),4);// yyyyMMdd or yyyy-MM-dd.
l="".concat(f).concat(u).concat(d).concat(u).concat(c)}// Representation is either 'time' or 'complete'
if("date"!==a){// Add the timezone.
var p=o.getTimezoneOffset();if(0!==p){var h=Math.abs(p),m=rQ(Math.floor(h/60),2),g=rQ(h%60,2);s="".concat(p<0?"+":"-").concat(m,":").concat(g)}else s="Z";var v=rQ(o.getHours(),2),y=rQ(o.getMinutes(),2),b=rQ(o.getSeconds(),2),w=""===l?"":"T",x=[v,y,b].join("extended"===i?":":"");// HHmmss or HH:mm:ss.
...
if(!o)return new Date(NaN);var i=!!o[4],a=rB(o[1]),l=rB(o[2])-1,s=rB(o[3]),u=rB(o[4]),c=rB(o[5])-1;if(i)return u>=1&&u<=53&&c>=0&&c<=6?((n=new Date(0)).setUTCFullYear(t,0,4),r=n.getUTCDay()||7,n.setUTCDate(n.getUTCDate()+((u-1)*7+c+1-r)),n):new Date(NaN);var d=new Date(0);return l>=0&&l<=11&&s>=1&&s<=(rq[l]||(rK(t)?29:28))&&a>=1&&a<=(rK(t)?366:365)?(d.setUTCFullYear(t,l,Math.max(a,s)),d):new Date(NaN)}(l.restDateString,l.year)}if(!r||isNaN(r.getTime()))return new Date(NaN);var s=r.getTime(),u=0;if(a.time&&isNaN(u=function(e){var t=e.match(rW);if(!t)return NaN;// Invalid ISO-formatted time
 ...
 * lucide-react v0.288.0 - ISC
 */const vj=x("Shuffle",[["path",{d:"M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.1-8.6c.7-1.1 2-1.7 3.3-1.7H22",key:"1wmou1"}],["path",{d:"m18 2 4 4-4 4",key:"pucp1d"}],["path",{d:"M2 6h1.9c1.5 0 2.9.9 3.6 2.2",key:"10bdb2"}],["path",{d:"M22 18h-5.9c-1.3 0-2.6-.7-3.3-1.8l-.5-.8",key:"vgxac0"}],["path",{d:"m18 14 4 4-4 4",key:"10pe0f"}]]),vI=x("Undo",[["path",{d:"M3 7v6h6",key:"1v2h90"}],["path",{d:"M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13",key:"1r6uu6"}]]),vD=x("SendHorizontal",[["path",{d:"m3 3 3 9-3 9 19-9Z",key:"1aobqy"}],["path",{d:"M6 12h16",key:"s4cdu5"}]]);var vM=function({shuffledRows:e,setShuffledRows:t,setGridShake:n}){let{isGameOver:r,guessCandidate:o,setGuessCandidate:i,submittedGuesses:a,setSubmittedGuesses:l,solvedGameData:s,setSolvedGameData:u}=/*@__PURE__*/f(y).useContext(oE),{gameData:c,categorySize:d}=/*@__PURE__*/f(y).useContext(ob),{toast:p}=dI();return/*#__PURE__*/(0,g.jsxs)("div",{className:"grid grid-cols-3 gap-4",children:[/*#__PURE__*/(0,g.jsxs)(rp,{disabled:r,variant:"secondary",onClick:()=>t(rP({gameData:e})),children:[/*#__PURE__*/(0,g.jsx)(vj,{className:"h-4 w-4 mr-2",strokeWidth:1}),/*#__PURE__*/(0,g.jsx)("p",{className:"select-none",children:"Shuffle"})]}),/*#__PURE__*/(0,g.jsxs)(rp,{size:"deselectallsize",disabled:r,variant:"secondary",onClick:function(){i([])},children:[/*#__PURE__*/(0,g.jsx)(vI,{className:"h-4 w-4 mr-2",strokeWidth:1}),/*#__PURE__*/(0,g.jsx)("p",{className:"select-none",children:"Deselect All"})]}),/*#__PURE__*/(0,g.jsxs)(rp,{variant:"submit",onClick:function(){// check that its a valid guess by size
