...
],[p,[c,R+" Focus"]],[/\bopt\/([\w\.]+)/i// Opera Touch
...
],[p,[c,R]],[/\bqihu|(qi?ho?o?|360)browser/i// 360
...
],[p,[c,R+" Reality"]],[/ekiohf.+(flow)\/([\w\.]+)/i,/(swiftfox)/i,/(icedragon|iceweasel|camino|chimera|fennec|maemo browser|minimo|conkeror|klar)[\/ ]?([\w\.\+]+)/i,// IceDragon/Iceweasel/Camino/Chimera/Fennec/Maemo/Minimo/Conkeror/Klar
...
/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i],[u,[f,M],[d,g]],[/sony tablet [ps]/i,/\b(?:sony)?sgp\w+(?: bui|\))/i],[[u,"Xperia Tablet"],[f,M],[d,v]],[// OnePlus
...
],[[u,_+"cast"],[f,P],[d,y]],[/droid.+aft(\w+)( bui|\))/i// Fire TV
],[u,[f,x],[d,y]],[/\(dtv[\);].+(aquos)/i,/(aquos-tv[\w ]+)\)/i// Sharp
],[u,[f,I],[d,y]],[/(bravia[\w ]+)( bui|\))/i// Sony
],[u,[f,M],[d,y]],[/(mitv-\w{5}) bui/i// Xiaomi
...
],[u,[f,M],[d,m]],[/\b(xbox(?: one)?(?!; xbox))[\); ]/i// Microsoft Xbox
],[u,[f,N],[d,m]],[///////////////////
// WEARABLES
///////////////////
/((pebble))app/i// Pebble
...
],[p,[c,R+" OS"]],[/web0s;.+rt(tv)/i,/\b(?:hp)?wos(?:browser)?\/([\w\.]+)/i// WebOS
 ...
 * Slot
 * -----------------------------------------------------------------------------------------------*/let P=/*#__PURE__*/(0,y.forwardRef)((e,t)=>{let{children:n,...r}=e,o=(0,y.Children).toArray(n),i=o.find(O);if(i){// the new element to render is the one passed as a child of `Slottable`
 ...
 */let j=(null==globalThis?void 0:globalThis.document)?y.useLayoutEffect:()=>{},I=y["useId".toString()]||(()=>void 0),M=0;function D(e){let[t,n]=y.useState(I());// React versions older than 18 will have client-side ids only.
return j(()=>{e||n(e=>null!=e?e:String(M++))},[e]),e||(t?`radix-${t}`:"")}var y=m("exYeM");// https://github.com/DefinitelyTyped/DefinitelyTyped/pull/55396
// prettier-ignore
/* -------------------------------------------------------------------------------------------------
 * Primitive
 * -----------------------------------------------------------------------------------------------*/let z=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","span","svg","ul"].reduce((e,t)=>{let n=/*#__PURE__*/(0,y.forwardRef)((e,n)=>{let{asChild:r,...o}=e,i=r?P:t;return(0,y.useEffect)(()=>{window[Symbol.for("radix-ui")]=!0},[]),/*#__PURE__*/(0,y.createElement)(i,k({},o,{ref:n}))});return n.displayName=`Primitive.${t}`,{...e,[t]:n}},{});/* -------------------------------------------------------------------------------------------------
 * Utils
 * -----------------------------------------------------------------------------------------------*//**
...
.filter(function(e){if(!e.isTailwindClass)return!0;var t=e.modifierId,n=e.classGroupId,r=e.hasPostfixModifier,o=t+n;return!s.has(o)&&(s.add(o),l(n,r).forEach(function(e){return s.add(t+e)}),!0)}).reverse().map(function(e){return e.originalClassName}).join(" "));return n(r,c),c}return function(){return a(eS.apply(null,arguments))}}(function(){var e=ek("colors"),t=ek("spacing"),n=ek("blur"),r=ek("brightness"),o=ek("borderColor"),i=ek("borderRadius"),a=ek("borderSpacing"),l=ek("borderWidth"),s=ek("contrast"),u=ek("grayscale"),c=ek("hueRotate"),d=ek("invert"),f=ek("gap"),p=ek("gradientColorStops"),h=ek("gradientColorStopPositions"),m=ek("inset"),g=ek("margin"),v=ek("opacity"),y=ek("padding"),b=ek("saturate"),w=ek("scale"),x=ek("sepia"),S=ek("skew"),k=ek("space"),E=ek("translate"),C=function(){return["auto","contain","none"]},_=function(){return["auto","hidden","clip","visible","scroll"]},R=function(){return["auto",eF,t]},P=function(){return[eF,t]},T=function(){return["",eN]},N=function(){return["auto",eD,eF]},O=function(){return["bottom","center","left","left-bottom","left-top","right","right-bottom","right-top","top"]},A=function(){return["solid","dashed","dotted","double","none"]},j=function(){return["normal","multiply","screen","overlay","darken","lighten","color-dodge","color-burn","hard-light","soft-light","difference","exclusion","hue","saturation","color","luminosity","plus-lighter"]},I=function(){return["start","end","center","between","around","evenly","stretch"]},M=function(){return["","0",eF]},D=function(){return["auto","avoid","all","avoid-page","page","left","right","column"]},z=function(){return[eD,eM]},L=function(){return[eD,eF]};return{cacheSize:500,theme:{colors:[e$],spacing:[eN],blur:["none","",eU,eF],brightness:z(),borderColor:[e],borderRadius:["none","","full",eU,eF],borderSpacing:P(),borderWidth:T(),contrast:z(),grayscale:M(),hueRotate:L(),invert:M(),gap:P(),gradientColorStops:[e],gradientColorStopPositions:[ez,eO],inset:R(),margin:R(),opacity:z(),padding:P(),saturate:z(),scale:z(),sepia:M(),skew:L(),space:P(),translate:P()},classGroups:{// Layout
/**
       * Aspect Ratio
...
/**
       ...
       */"line-clamp":[{"line-clamp":["none",eD,eM]}],/**
       * Line Height
...
console.warn(Error().stack)),new Date(NaN)))}function rz(e,t){rM(2,arguments);var n=rD(e),r=rj(t);return isNaN(r)?new Date(NaN):(r&&n.setDate(n.getDate()+r),n)}/**
...
if(!o)return new Date(NaN);var i=!!o[4],a=rG(o[1]),l=rG(o[2])-1,s=rG(o[3]),u=rG(o[4]),c=rG(o[5])-1;if(i)return u>=1&&u<=53&&c>=0&&c<=6?((n=new Date(0)).setUTCFullYear(t,0,4),r=n.getUTCDay()||7,n.setUTCDate(n.getUTCDate()+((u-1)*7+c+1-r)),n):new Date(NaN);var d=new Date(0);return l>=0&&l<=11&&s>=1&&s<=(rq[l]||(rK(t)?29:28))&&a>=1&&a<=(rK(t)?366:365)?(d.setUTCFullYear(t,l,Math.max(a,s)),d):new Date(NaN)}(l.restDateString,l.year)}if(!r||isNaN(r.getTime()))return new Date(NaN);var s=r.getTime(),u=0;if(a.time&&isNaN(u=function(e){var t=e.match(rH);if(!t)return NaN;// Invalid ISO-formatted time
var n=rY(t[1]),r=rY(t[2]),o=rY(t[3]);return(24===n?0===r&&0===o:o>=0&&o<60&&r>=0&&r<60&&n>=0&&n<25)?36e5*n+6e4*r+1e3*o:NaN}(a.time)))return new Date(NaN);if(a.timezone){if(isNaN(o=function(e){if("Z"===e)return 0;var t=e.match(rB);if(!t)return 0;var n="+"===t[1]?-1:1,r=parseInt(t[2]),o=t[3]&&parseInt(t[3])||0;return o>=0&&o<=59?n*(36e5*r+6e4*o):NaN}(a.timezone)))return new Date(NaN)}else{var c=new Date(s+u),d=new Date(0);return d.setFullYear(c.getUTCFullYear(),c.getUTCMonth(),c.getUTCDate()),d.setHours(c.getUTCHours(),c.getUTCMinutes(),c.getUTCSeconds(),c.getUTCMilliseconds()),d}return new Date(s+u+o)}(e.d?.toString()));if(t>=ol()||t<os)return op(ol()),ol();return t}catch(e){return console.log(e),ol()}})()),ob=/*@__PURE__*/f(y).createContext();var ow=function({children:e}){let[t,n]=/*@__PURE__*/f(y).useState(om),r=t[0].words.length,o=t.length;return/*#__PURE__*/(0,g.jsx)(ob.Provider,{value:{gameData:t,numCategories:o,categorySize:r},children:e})};let ox="gameState",oS=e=>{localStorage.setItem(ox,JSON.stringify(e))},ok=()=>{let e=localStorage.getItem(ox);return e?JSON.parse(e):null},oE=/*@__PURE__*/f(y).createContext();var oC=function({children:e}){let{gameData:t}=/*@__PURE__*/f(y).useContext(ob),[n,r]=/*@__PURE__*/f(y).useState([]),[o,i]=/*@__PURE__*/f(y).useState(()=>{let e=ok();return(// console.log("checking game state!", {
...
var i_=(e,t,n)=>{if(oK.fun(e))return e;if(oK.arr(e))return i_({range:e,output:t,extrapolate:n});if(oK.str(e.output[0]))return u7(e);let r=e.output,o=e.range||[0,1],i=e.extrapolateLeft||e.extrapolate||"extend",a=e.extrapolateRight||e.extrapolate||"extend",l=e.easing||(e=>e);return t=>{let n=function(e,t){for(var n=1;n<t.length-1&&!(t[n]>=e);++n);return n-1}(t,o);return function(e,t,n,r,o,i,a,l,s){let u=s?s(e):e;if(u<t){if("identity"===a)return u;"clamp"===a&&(u=t)}if(u>n){if("identity"===l)return u;"clamp"===l&&(u=n)}return r===o?r:t===n?e<=t?r:o:(t===-1/0?u=-u:n===1/0?u-=t:u=(u-t)/(n-t),u=i(u),r===-1/0?u=-u:o===1/0?u+=r:u=u*(o-r)+r,u)}(t,o[n],o[n+1],r[n],r[n+1],l,i,a,e.map)}},iR=Symbol.for("FluidValue.get"),iP=Symbol.for("FluidValue.observers"),iT=e=>!!(e&&e[iR]),iN=e=>e&&e[iR]?e[iR]():e,iO=e=>e[iP]||null;function iA(e,t){let n=e[iP];n&&n.forEach(e=>{e.eventObserved?e.eventObserved(t):e(t)})}var ij=class{constructor(e){if(!e&&!(e=this.get))throw Error("Unknown getter");iI(this,e)}},iI=(e,t)=>iz(e,iR,t);function iM(e,t){if(e[iR]){let n=e[iP];n||iz(e,iP,n=/* @__PURE__ */new Set),!n.has(t)&&(n.add(t),e.observerAdded&&e.observerAdded(n.size,t))}return t}function iD(e,t){let n=e[iP];if(n&&n.has(t)){let r=n.size-1;r?n.delete(t):e[iP]=null,e.observerRemoved&&e.observerRemoved(r,t)}}var iz=(e,t,n)=>Object.defineProperty(e,t,{value:n,writable:!0,configurable:!0}),iL=/[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,iF=/(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi,i$=RegExp(`(${iL.source})(%|[a-z]+)`,"i"),iU=/rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,iV=/var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/,iW=e=>{let[t,n]=iH(e);if(!t||o2())return e;let r=window.getComputedStyle(document.documentElement).getPropertyValue(t);if(r)return r.trim();if(n&&n.startsWith("--")){let e=window.getComputedStyle(document.documentElement).getPropertyValue(n);if(e)return e}else if(n&&iV.test(n))return iW(n);else if(n)return n;return e},iH=e=>{let t=iV.exec(e);if(!t)return[,];let[,n,r]=t;return[n,r]},iB=(e,t,n,r,o)=>`rgba(${Math.round(t)}, ${Math.round(n)}, ${Math.round(r)}, ${o})`,iG=e=>{ct||(ct=o3?RegExp(`(${Object.keys(o3).join("|")})(?!\\w)`,"g"):/^\b$/);let t=e.output.map(e=>iN(e).replace(iV,iW).replace(iF,iC).replace(ct,iC)),n=t.map(e=>e.match(iL).map(Number)),r=n[0].map((e,t)=>n.map(e=>{if(!(t in e))throw Error('The arity of each "output" value must be equal');return e[t]})),o=r.map(t=>i_({...e,output:t}));return e=>{let n=!i$.test(t[0])&&t.find(e=>i$.test(e))?.replace(iL,""),r=0;return t[0].replace(iL,()=>`${o[r++](e)}${n||""}`).replace(iU,iB)}},iY="react-spring: ",iq=e=>{let t=!1;if("function"!=typeof e)throw TypeError(`${iY}once requires a function parameter`);return(...n)=>{t||(e(...n),t=!0)}},iK=iq(console.warn),iQ=iq(console.warn);// src/isAnimatedString.ts
...
o!==n.asyncId&&aN(r,!1);if(t)throw e.result=t,c(e),e},m=(e,t)=>{let i=new aI,a=new aM;return(async()=>{if(oP.skipAnimation)throw aj(n),a.result=aN(r,!1),c(a),a;h(i);let l=oK.obj(e)?{...e}:{...t,to:e};l.parentId=o,oZ(f,(e,t)=>{oK.und(l[t])&&(l[t]=e)});let s=await r.start(l);return h(i),n.paused&&await new Promise(e=>{n.resumeQueue.add(e)}),s})()};if(oP.skipAnimation)return aj(n),aN(r,!1);try{let t;t=oK.arr(e)?(async e=>{for(let t of e)await m(t)})(e):Promise.resolve(e(m,r.stop.bind(r))),await Promise.all([t.then(u),p]),d=aN(r.get(),!0,!1)}catch(e){if(e instanceof aI)d=e.result;else if(e instanceof aM)d=e.result;else throw e}finally{o==n.asyncId&&(n.asyncId=i,n.asyncTo=i?l:void 0,n.promise=i?s:void 0)}return oK.fun(a)&&oN.batchedUpdates(()=>{a(d,r,r.item)}),d})():s}function aj(e,t){o0(e.timeouts,e=>e.cancel()),e.pauseQueue.clear(),e.resumeQueue.clear(),e.asyncId=e.asyncTo=e.promise=void 0,t&&(e.cancelId=t)}var aI=class extends Error{constructor(){super("An async animation has been interrupted. You see this error because you forgot to use `await` or `.catch(...)` on its returned promise.")}},aM=class extends Error{constructor(){super("SkipAnimationSignal")}},aD=e=>e instanceof aL,az=1,aL=class extends ij{constructor(){super(...arguments),this.id=az++,this._priority=0}get priority(){return this._priority}set priority(e){this._priority!=e&&(this._priority=e,this._onPriorityChange(e))}/** Get the current value */get(){let e=i6(this);return e&&e.getValue()}/** Create a spring that maps our value to another value */to(...e){return oP.to(this,e)}/** @deprecated Use the `to` method instead. */interpolate(...e){return iK(`${iY}The "interpolate" function is deprecated in v9 (use "to" instead)`),oP.to(this,e)}toJSON(){return this.get()}observerAdded(e){1==e&&this._attach()}observerRemoved(e){0==e&&this._detach()}/** Called when the first child is added. */_attach(){}/** Called when the last child is removed. */_detach(){}/** Tell our children about our new value */_onChange(e,t=!1){iA(this,{type:"change",parent:this,value:e,idle:t})}/** Tell our children about our new priority */_onPriorityChange(e){this.idle||it.sort(this),iA(this,{type:"priority",parent:this,priority:e})}},aF=Symbol.for("SpringPhase"),a$=e=>(1&e[aF])>0,aU=e=>(2&e[aF])>0,aV=e=>(4&e[aF])>0,aW=(e,t)=>t?e[aF]|=3:e[aF]&=-3,aH=(e,t)=>t?e[aF]|=4:e[aF]&=-5,aB=class extends aL{constructor(e,t){if(super(),/** The animation state */this.animation=new a_,/** Some props have customizable default values */this.defaultProps={},/** The state for `runAsync` calls */this._state={paused:!1,delayed:!1,pauseQueue:/* @__PURE__ */new Set,resumeQueue:/* @__PURE__ */new Set,timeouts:/* @__PURE__ */new Set},/** The promise resolvers of pending `start` calls */this._pendingCalls=/* @__PURE__ */new Set,/** The counter for tracking `scheduleProps` calls */this._lastCallId=0,/** The last `scheduleProps` call that changed the `to` prop */this._lastToId=0,this._memoizedDuration=0,!oK.und(e)||!oK.und(t)){let n=oK.obj(e)?{...e}:{...t,from:e};oK.und(n.default)&&(n.default=!0),this.start(n)}}/** Equals true when not advancing on each frame. */get idle(){return!(aU(this)||this._state.asyncTo)||aV(this)}get goal(){return iN(this.animation.to)}get velocity(){let e=i6(this);return e instanceof ae?e.lastVelocity||0:e.getPayload().map(e=>e.lastVelocity||0)}/**
...
getComponentProps:({scrollTop:e,scrollLeft:t,...n})=>n}).animated,y=(m("exYeM"),m("exYeM"),m("exYeM"));let lb=["top","right","bottom","left"],lw=Math.min,lx=Math.max,lS=Math.round,lk=Math.floor,lE=e=>({x:e,y:e}),lC={left:"right",right:"left",bottom:"top",top:"bottom"},l_={start:"end",end:"start"};function lR(e,t){return"function"==typeof e?e(t):e}function lP(e){return e.split("-")[0]}function lT(e){return e.split("-")[1]}function lN(e){return"x"===e?"y":"x"}function lO(e){return"y"===e?"height":"width"}function lA(e){return["top","bottom"].includes(lP(e))?"y":"x"}function lj(e){return e.replace(/start|end/g,e=>l_[e])}function lI(e){return e.replace(/left|right|bottom|top/g,e=>lC[e])}function lM(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function lD(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}function lz(e,t,n){let r,{reference:o,floating:i}=e,a=lA(t),l=lN(lA(t)),s=lO(l),u=lP(t),c="y"===a,d=o.x+o.width/2-i.width/2,f=o.y+o.height/2-i.height/2,p=o[s]/2-i[s]/2;switch(u){case"top":r={x:d,y:o.y-i.height};break;case"bottom":r={x:d,y:o.y+o.height};break;case"right":r={x:o.x+o.width,y:f};break;case"left":r={x:o.x-i.width,y:f};break;default:r={x:o.x,y:o.y}}switch(lT(t)){case"start":r[l]-=p*(n&&c?-1:1);break;case"end":r[l]+=p*(n&&c?-1:1)}return r}/**
...
let r=new Map,o={platform:sa,...n},i={...o.platform,_c:r};return lL(e,t,{...o,platform:i})};var y=m("exYeM");/**
 * Provides data to position an inner element of the floating element so that it
 * appears centered to the reference element.
 ...
 * Popper
 * -----------------------------------------------------------------------------------------------*/let sm="Popper",[sg,sv]=C(sm),[sy,sb]=sg(sm),sw=/*#__PURE__*/(0,y.forwardRef)((e,t)=>{let{__scopePopper:n,virtualRef:r,...o}=e,i=sb("PopperAnchor",n),a=(0,y.useRef)(null),l=R(t,a);return(0,y.useEffect)(()=>{// Consumer can anchor the popper to something that isn't
// a DOM node e.g. pointer position, so we override the
// `anchorRef` with their virtual ref in this case.
i.onAnchorChange((null==r?void 0:r.current)||a.current)}),r?null:/*#__PURE__*/(0,y.createElement)(z.div,k({},o,{ref:l}))}),sx="PopperContent",[sS,sk]=sg(sx),sE=/*#__PURE__*/(0,y.forwardRef)((e,t)=>{var n,r,o,i,a,l,s,u,c,d,f,p,h,m;let{__scopePopper:g,side:b="bottom",sideOffset:w=0,align:x="center",alignOffset:S=0,arrowPadding:E=0,avoidCollisions:C=!0,collisionBoundary:_=[],collisionPadding:P=0,sticky:T="partial",hideWhenDetached:N=!1,updatePositionStrategy:O="optimized",onPlaced:A,...I}=e,M=sb(sx,g),[D,L]=(0,y.useState)(null),$=R(t,e=>L(e)),[U,V]=(0,y.useState)(null),W=function(e){let[t,n]=(0,y.useState)(void 0);return j(()=>{if(e){// provide size as early as possible
...
r=e.offsetWidth,o=e.offsetHeight;n({width:r,height:o})});return t.observe(e,{box:"border-box"}),()=>t.unobserve(e)}n(void 0)},[e]),t}(U),H=null!==(n=null==W?void 0:W.width)&&void 0!==n?n:0,B=null!==(r=null==W?void 0:W.height)&&void 0!==r?r:0,G="number"==typeof P?P:{top:0,right:0,bottom:0,left:0,...P},Y=Array.isArray(_)?_:[_],q=Y.length>0,K={padding:G,boundary:Y.filter(s_),// with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
altBoundary:q},{refs:Q,floatingStyles:X,placement:Z,isPositioned:J,middlewareData:ee}=/**
 * Provides data to position a floating element.
 * @see https://floating-ui.com/docs/react
 */function(e){void 0===e&&(e={});let{placement:t="bottom",strategy:n="absolute",middleware:r=[],platform:o,elements:{reference:i,floating:a}={},transform:l=!0,whileElementsMounted:s,open:u}=e,[c,d]=y.useState({x:0,y:0,strategy:n,placement:t,middlewareData:{},isPositioned:!1}),[f,p]=y.useState(r);sc(f,r)||p(r);let[h,m]=y.useState(null),[g,b]=y.useState(null),w=y.useCallback(e=>{e!=E.current&&(E.current=e,m(e))},[m]),x=y.useCallback(e=>{e!==C.current&&(C.current=e,b(e))},[b]),S=i||h,k=a||g,E=y.useRef(null),C=y.useRef(null),_=y.useRef(c),R=sp(s),P=sp(o),T=y.useCallback(()=>{if(!E.current||!C.current)return;let e={placement:t,strategy:n,middleware:f};P.current&&(e.platform=P.current),sl(E.current,C.current,e).then(e=>{let t={...e,isPositioned:!0};N.current&&!sc(_.current,t)&&(_.current=t,v.flushSync(()=>{d(t)}))})},[f,t,n,P]);su(()=>{!1===u&&_.current.isPositioned&&(_.current.isPositioned=!1,d(e=>({...e,isPositioned:!1})))},[u]);let N=y.useRef(!1);su(()=>(N.current=!0,()=>{N.current=!1}),[]),su(()=>{if(S&&(E.current=S),k&&(C.current=k),S&&k){if(R.current)return R.current(S,k,T);T()}},[S,k,T,R]);let O=y.useMemo(()=>({reference:E,floating:C,setReference:w,setFloating:x}),[w,x]),A=y.useMemo(()=>({reference:S,floating:k}),[S,k]),j=y.useMemo(()=>{let e={position:n,left:0,top:0};if(!A.floating)return e;let t=sf(A.floating,c.x),r=sf(A.floating,c.y);return l?{...e,transform:"translate("+t+"px, "+r+"px)",...sd(A.floating)>=1.5&&{willChange:"transform"}}:{position:n,left:t,top:r}},[n,l,A.floating,c.x,c.y]);return y.useMemo(()=>({...c,update:T,refs:O,elements:A,floatingStyles:j}),[c,T,O,A,j])}({// default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
...
h.unobserve(t),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{h&&h.observe(t)})),n()}),c&&!u&&h.observe(c),h.observe(t));let m=u?se(e):null;return u&&function t(){let r=se(e);m&&(r.x!==m.x||r.y!==m.y||r.width!==m.width||r.height!==m.height)&&n(),m=r,o=requestAnimationFrame(t)}(),n(),()=>{d.forEach(e=>{i&&e.removeEventListener("scroll",n),a&&e.removeEventListener("resize",n)}),f&&f(),h&&h.disconnect(),h=null,u&&cancelAnimationFrame(o)}}(...e,{animationFrame:"always"===O});return t},elements:{reference:M.anchor},middleware:[{name:"offset",options:c={mainAxis:w+B,alignmentAxis:S},async fn(e){let{x:t,y:n}=e,r=await lW(e,c);return{x:t+r.x,y:n+r.y,data:r}}},C&&{name:"shift",options:f={mainAxis:!0,crossAxis:!1,limiter:"partial"===T?(void 0===d&&(d={}),{options:d,fn(e){let{x:t,y:n,placement:r,rects:o,middlewareData:i}=e,{offset:a=0,mainAxis:l=!0,crossAxis:s=!0}=lR(d,e),u={x:t,y:n},c=lA(r),f=lN(c),p=u[f],h=u[c],m=lR(a,e),g="number"==typeof m?{mainAxis:m,crossAxis:0}:{mainAxis:0,crossAxis:0,...m};if(l){let e="y"===f?"height":"width",t=o.reference[f]-o.floating[e]+g.mainAxis,n=o.reference[f]+o.reference[e]-g.mainAxis;p<t?p=t:p>n&&(p=n)}if(s){var v,y;let e="y"===f?"width":"height",t=["top","left"].includes(lP(r)),n=o.reference[c]-o.floating[e]+(t&&(null==(v=i.offset)?void 0:v[c])||0)+(t?0:g.crossAxis),a=o.reference[c]+o.reference[e]+(t?0:(null==(y=i.offset)?void 0:y[c])||0)-(t?g.crossAxis:0);h<n?h=n:h>a&&(h=a)}return{[f]:p,[c]:h}}}):void 0,...K},async fn(e){let{x:t,y:n,placement:r}=e,{mainAxis:o=!0,crossAxis:i=!1,limiter:a={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=lR(f,e),s={x:t,y:n},u=await lF(e,l),c=lA(lP(r)),d=lN(c),p=s[d],h=s[c];if(o){let e=p+u["y"===d?"top":"left"],t=p-u["y"===d?"bottom":"right"];p=lx(e,lw(p,t))}if(i){let e="y"===c?"top":"left",t="y"===c?"bottom":"right",n=h+u[e],r=h-u[t];h=lx(n,lw(h,r))}let m=a.fn({...e,[d]:p,[c]:h});return{...m,data:{x:m.x-t,y:m.y-n}}}},C&&{name:"flip",options:p={...K},async fn(e){var t,n,r,o,i;let{placement:a,middlewareData:l,rects:s,initialPlacement:u,platform:c,elements:d}=e,{mainAxis:f=!0,crossAxis:h=!0,fallbackPlacements:m,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:v="none",flipAlignment:y=!0,...b}=lR(p,e);// If a reset by the arrow was caused due to an alignment offset being
// added, we should skip any logic now since `flip()` has already done its
// work.
// https://github.com/floating-ui/floating-ui/issues/2549#issuecomment-1719601643
if(null!=(t=l.arrow)&&t.alignmentOffset)return{};let w=lP(a),x=lP(u)===u,S=await (null==c.isRTL?void 0:c.isRTL(d.floating)),k=m||(x||!y?[lI(u)]:function(e){let t=lI(e);return[lj(e),t,lj(t)]}(u));m||"none"===v||k.push(...function(e,t,n,r){let o=lT(e),i=function(e,t,n){let r=["left","right"],o=["right","left"];switch(e){case"top":case"bottom":if(n)return t?o:r;return t?r:o;case"left":case"right":return t?["top","bottom"]:["bottom","top"];default:return[]}}(lP(e),"start"===n,r);return o&&(i=i.map(e=>e+"-"+o),t&&(i=i.concat(i.map(lj)))),i}(u,y,v,S));let E=[u,...k],C=await lF(e,b),_=[],R=(null==(n=l.flip)?void 0:n.overflows)||[];if(f&&_.push(C[w]),h){let e=function(e,t,n){void 0===n&&(n=!1);let r=lT(e),o=lN(lA(e)),i=lO(o),a="x"===o?r===(n?"end":"start")?"right":"left":"start"===r?"bottom":"top";return t.reference[i]>t.floating[i]&&(a=lI(a)),[a,lI(a)]}(a,s,S);_.push(C[e[0]],C[e[1]])}// One or more sides is overflowing.
if(R=[...R,{placement:a,overflows:_}],!_.every(e=>e<=0)){let e=((null==(r=l.flip)?void 0:r.index)||0)+1,t=E[e];if(t)return{data:{index:e,overflows:R},reset:{placement:t}};// First, find the candidates that fit on the mainAxis side of overflow,
// then find the placement that fits the best on the main crossAxis side.
let n=null==(o=R.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:o.placement;// Otherwise fallback.
if(!n)switch(g){case"bestFit":{let e=null==(i=R.map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:i[0];e&&(n=e);break}case"initialPlacement":n=u}if(a!==n)return{reset:{placement:n}}}return{}}},{name:"size",options:h={...K,apply:({elements:e,rects:t,availableWidth:n,availableHeight:r})=>{let{width:o,height:i}=t.reference,a=e.floating.style;a.setProperty("--radix-popper-available-width",`${n}px`),a.setProperty("--radix-popper-available-height",`${r}px`),a.setProperty("--radix-popper-anchor-width",`${o}px`),a.setProperty("--radix-popper-anchor-height",`${i}px`)}},async fn(e){let t,n;let{placement:r,rects:o,platform:i,elements:a}=e,{apply:l=()=>{},...s}=lR(h,e),u=await lF(e,s),c=lP(r),d=lT(r),f="y"===lA(r),{width:p,height:m}=o.floating;"top"===c||"bottom"===c?(t=c,n=d===(await (null==i.isRTL?void 0:i.isRTL(a.floating))?"start":"end")?"left":"right"):(n=c,t="end"===d?"top":"bottom");let g=m-u[t],v=p-u[n],y=!e.middlewareData.shift,b=g,w=v;if(f){let e=p-u.left-u.right;w=d||y?lw(v,e):e}else{let e=m-u.top-u.bottom;b=d||y?lw(g,e):e}if(y&&!d){let e=lx(u.left,0),t=lx(u.right,0),n=lx(u.top,0),r=lx(u.bottom,0);f?w=p-2*(0!==e||0!==t?e+t:lx(u.left,u.right)):b=m-2*(0!==n||0!==r?n+r:lx(u.top,u.bottom))}await l({...e,availableWidth:w,availableHeight:b});let x=await i.getDimensions(a.floating);return p!==x.width||m!==x.height?{reset:{rects:!0}}:{}}},U&&ss({element:U,padding:E}),sR({arrowWidth:H,arrowHeight:B}),N&&{name:"hide",options:m={strategy:"referenceHidden",...K},async fn(e){let{rects:t}=e,{strategy:n="referenceHidden",...r}=lR(m,e);switch(n){case"referenceHidden":{let n=await lF(e,{...r,elementContext:"reference"}),o=lU(n,t.reference);return{data:{referenceHiddenOffsets:o,referenceHidden:lV(o)}}}case"escaped":{let n=await lF(e,{...r,altBoundary:!0}),o=lU(n,t.floating);return{data:{escapedOffsets:o,escaped:lV(o)}}}default:return{}}}}]}),[et,en]=sP(Z),er=F(A);j(()=>{J&&(null==er||er())},[J,er]);let eo=null===(o=ee.arrow)||void 0===o?void 0:o.x,ei=null===(i=ee.arrow)||void 0===i?void 0:i.y,ea=(null===(a=ee.arrow)||void 0===a?void 0:a.centerOffset)!==0,[el,es]=(0,y.useState)();return j(()=>{D&&es(window.getComputedStyle(D).zIndex)},[D]),/*#__PURE__*/(0,y.createElement)("div",{ref:Q.setFloating,"data-radix-popper-content-wrapper":"",style:{...X,transform:J?X.transform:"translate(0, -200%)",// keep off the page when measuring
...
return cn.call(this,e,0)}}}!function(){try{cn="function"==typeof setTimeout?setTimeout:uI}catch(e){cn=uI}try{cr="function"==typeof clearTimeout?clearTimeout:uM}catch(e){cr=uM}}();var uz=[],uL=!1,uF=-1;function u$(){uL&&co&&(uL=!1,co.length?uz=co.concat(uz):uF=-1,uz.length&&uU())}function uU(){if(!uL){var e=uD(u$);uL=!0;for(var t=uz.length;t;){for(co=uz,uz=[];++uF<t;)co&&co[uF].run();uF=-1,t=uz.length}co=null,uL=!1,function(e){if(cr===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
if((cr===uM||!cr)&&clearTimeout)return cr=clearTimeout,clearTimeout(e);try{// when when somebody has screwed with setTimeout but no I.E. maddness
 ...
 *  else `false`.
 */function(e,t,n){if(!fw(n))return!1;var r=typeof t;return("number"==r?!!(fl(n)&&fS(t,n.length)):"string"==r&&t in n)&&fa(n[t],e)};var fE={},fC={},f_={},fR={},fP=/\s/;fR=/**
 ...
 */function(e){for(var t=e.length;t--&&fP.test(e.charAt(t)););return t};/** Used to match leading whitespace. */var fT=/^\s+/;f_=/**
 * The base implementation of `_.trim`.
 *
 * @private
 * @param {string} string The string to trim.
 * @returns {string} Returns the trimmed string.
 */function(e){return e?e.slice(0,fR(e)+1).replace(fT,""):e};var fN={},fO={};fO=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||fO(e)&&"[object Symbol]"==fu(e)};/** Used as references for various `Number` constants. */var fA=0/0,fj=/^[-+]0x[0-9a-f]+$/i,fI=/^0b[01]+$/i,fM=/^0o[0-7]+$/i,fD=parseInt;fC=/**
...
e=fE(e),void 0===t?(t=e,e=0):t=fE(t),n=void 0===n?e<t?1:-1:fE(n),fn(e,t,n,void 0)};var y=m("exYeM"),fF={},f$={};f$=m("beWdq");/**
...
for(var r=0;r<t.length;r++)if(t[r].options.index>n){t.splice(r,0,e);return}}}/**
   ...
   */,t.toString=function(e){for(var t=void 0===e?{}:e,n=t.attached,r=fL(t,["attached"]),o=pa(r).linebreak,i="",a=0;a<this.registry.length;a++){var l=this.registry[a];(null==n||l.attached===n)&&(i&&(i+=o),i+=l.toString(r))}return i},f9(e,[{key:"index",/**
...
if(!1===(r=pK(n,e.toString({children:!1}),o)))return!1;this.refCssRule(e,o,r)}return this.insertRules(e.rules,r),r}var i=e.toString();if(!i)return!1;var a=pQ(n,t),l=pK(n,i,a);return!1!==l&&(this.hasInsertedRules=!0,this.refCssRule(e,a,l),l)},t.refCssRule=function(e,t,n){e.renderable=n,e.options.parent instanceof pM&&this.cssRules.splice(t,0,n)}/**
   * Delete a rule.
   ...
   */,t.createStyleSheet=function(e,t){void 0===t&&(t={});var n=t.index;"number"!=typeof n&&(n=0===pz.index?0:pz.index+1);var r=new pM(e,k({},t,{jss:this,generateId:t.generateId||this.generateId,insertionPoint:this.options.insertionPoint,Renderer:this.options.Renderer,index:n}));return this.plugins.onProcessSheet(r),r}/**
...
delete e[o]}return e}(e,n,hT[t],r)),Object.keys(e).length)for(var a in hP[t]){if(e[a]){Array.isArray(e[a])?i.push(null===hR[a]?e[a]:e[a].join(" ")):i.push(e[a]);continue}// Add default value from props config.
...
var hj="",hI="",hM="",hD="",hz=f5&&"ontouchstart"in document.documentElement;if(f5){// Order matters. We need to check Webkit the last one because
// other vendors use to add Webkit prefixes to some properties
var hL={Moz:"-moz-",ms:"-ms-",O:"-o-",Webkit:"-webkit-"},hF=document.createElement("p").style;for(var h$ in hL)if(h$+"Transform" in hF){hj=h$,hI=hL[h$];break}"Webkit"===hj&&"msHyphens"in hF&&(hj="ms",hI=hL.ms,hD="edge"),"Webkit"===hj&&"-apple-trailing-word"in hF&&(hM="apple")}/**
 * Vendor prefix string for the current browser.
 *
 * @type {{js: String, css: String, vendor: String, browser: String}}
 * @api public
 */var hU={js:hj,css:hI,vendor:hM,browser:hD,isTouch:hz},hV=/[-\s]+(.)?/g;/**
 ...
 */function(e,t){for(var n=-1,r=null==e?0:e.length,o=Array(r);++n<r;)o[n]=t(e[n],n,e);return o};var m_={};m_=Array.isArray;/** Used as references for various `Number` constants. */var mR=1/0,mP=fc?fc.prototype:void 0,mT=mP?mP.toString:void 0;mE=/**
...
if("string"==typeof t)return t;if(m_(t))return mC(t,e)+"";if(fN(t))return mT?mT.call(t):"";var n=t+"";return"0"==n&&1/t==-mR?"-0":n},mk=/**
...
var n=(mk(e)+"e").split("e"),r=o(n[0]+"e"+(+n[1]+t));return+((n=(mk(r)+"e").split("e"))[0]+"e"+(+n[1]-t))}return o(e)};var mA={},mj={},mI={},mM={},mD={},mz={};mz=/**
...
mH.prototype.clear=mz,mH.prototype.delete=mL,mH.prototype.get=mU,mH.prototype.has=mV,mH.prototype.set=mW,mD=mH;var mB={};mB=/**
...
gb.prototype.clear=mB,gb.prototype.delete=mG,gb.prototype.get=mY,gb.prototype.has=mq,gb.prototype.set=mK,mM=gb;var gw={},gx={},gS={};gS=/**
...
if(p){if(!gC(t,function(e,t){if(!g_(p,t)&&(h===e||o(h,e,n,r,i)))return p.push(t)})){f=!1;break}}else if(!(h===m||o(h,m,n,r,i))){f=!1;break}}return i.delete(e),i.delete(t),f};var gR={},gP={},fd=m("8ThvE");gP=fd.Uint8Array;var gT={};gT=/**
 ...
 */function(e){var t=-1,n=Array(e.size);return e.forEach(function(e){n[++t]=e}),n};/** Used to convert symbols to primitives and strings. */var gO=fc?fc.prototype:void 0,gA=gO?gO.valueOf:void 0;gR=/**
...
a.set(e,t);var c=gw(l(e),l(t),r,o,i,a);return a.delete(e),c;case"[object Symbol]":if(gA)return gA.call(e)==gA.call(t)}return!1};var gj={},gI={},gM={},gD={};gD=/**
 ...
 */function(e,t){for(var n=-1,r=t.length,o=e.length;++n<r;)e[o+n]=t[n];return e},gM=/**
 ...
 */function(e,t,n){var r=t(e);return m_(e)?r:gD(r,n(e))};var gz={},gL={};gL=/**
 ...
 * @param {Object} object The object to query.
 * @returns {Array} Returns the array of property names and symbols.
 */function(e){return gM(e,gV,gz)};/** Used to check objects for own properties. */var g7=Object.prototype.hasOwnProperty;gj=/**
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function(e,t,n,r,o,i){var a=m_(e),l=m_(t),s=a?vv:ve(e),u=l?vv:ve(t);s=s==vg?vy:s,u=u==vg?vy:u;var c=s==vy,d=u==vy,f=s==u;if(f&&gQ(e)){if(!gQ(t))return!1;a=!0,c=!1}if(f&&!c)return i||(i=new mM),a||gX(e)?gw(e,t,n,r,o,i):gR(e,t,s,n,r,o,i);if(!(1&n)){var p=c&&vb.call(e,"__wrapped__"),h=d&&vb.call(t,"__wrapped__");if(p||h){var m=p?e.value():e,g=h?t.value():t;return i||(i=new mM),o(m,g,n,r,i)}}return!!f&&(i||(i=new mM),gj(e,t,n,r,o,i))},mj=/**
