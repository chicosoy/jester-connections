...
.filter(function(e){if(!e.isTailwindClass)return!0;var t=e.modifierId,n=e.classGroupId,r=e.hasPostfixModifier,o=t+n;return!s.has(o)&&(s.add(o),l(n,r).forEach(function(e){return s.add(t+e)}),!0)}).reverse().map(function(e){return e.originalClassName}).join(" "));return n(r,c),c}return function(){return a(eS.apply(null,arguments))}}(function(){var e=ek("colors"),t=ek("spacing"),n=ek("blur"),r=ek("brightness"),o=ek("borderColor"),i=ek("borderRadius"),a=ek("borderSpacing"),l=ek("borderWidth"),s=ek("contrast"),u=ek("grayscale"),c=ek("hueRotate"),d=ek("invert"),f=ek("gap"),p=ek("gradientColorStops"),h=ek("gradientColorStopPositions"),m=ek("inset"),g=ek("margin"),v=ek("opacity"),y=ek("padding"),b=ek("saturate"),w=ek("scale"),x=ek("sepia"),S=ek("skew"),k=ek("space"),E=ek("translate"),R=function(){return["auto","contain","none"]},C=function(){return["auto","hidden","clip","visible","scroll"]},_=function(){return["auto",eL,t]},P=function(){return[eL,t]},T=function(){return["",eN]},N=function(){return["auto",eM,eL]},O=function(){return["bottom","center","left","left-bottom","left-top","right","right-bottom","right-top","top"]},A=function(){return["solid","dashed","dotted","double","none"]},j=function(){return["normal","multiply","screen","overlay","darken","lighten","color-dodge","color-burn","hard-light","soft-light","difference","exclusion","hue","saturation","color","luminosity","plus-lighter"]},I=function(){return["start","end","center","between","around","evenly","stretch"]},D=function(){return["","0",eL]},M=function(){return["auto","avoid","all","avoid-page","page","left","right","column"]},z=function(){return[eM,eD]},F=function(){return[eM,eL]};return{cacheSize:500,theme:{colors:[e$],spacing:[eN],blur:["none","",eU,eL],brightness:z(),borderColor:[e],borderRadius:["none","","full",eU,eL],borderSpacing:P(),borderWidth:T(),contrast:z(),grayscale:D(),hueRotate:F(),invert:D(),gap:P(),gradientColorStops:[e],gradientColorStopPositions:[ez,eO],inset:_(),margin:_(),opacity:z(),padding:P(),saturate:z(),scale:z(),sepia:D(),skew:F(),space:P(),translate:P()},classGroups:{// Layout
/**
       * Aspect Ratio
 ...
 */function(e,{select:t=!1}={}){let n=document.activeElement;for(let r of e)if(tY(r,{select:t}),document.activeElement!==n)return}(tK(l).filter(e=>"A"!==e.tagName),{select:!0}),document.activeElement===e&&tY(l))}return()=>{l.removeEventListener(tH,u),// We need to delay the focus a little to get around it for now.
// See: https://github.com/facebook/react/issues/17894
setTimeout(()=>{let t=new CustomEvent(tB,tG);l.addEventListener(tB,c),l.dispatchEvent(t),t.defaultPrevented||tY(null!=e?e:document.body,{select:!0}),// we need to remove the listener after we `dispatchEvent`
 ...
 */function(e){let t=tK(e),n=tQ(t,e),r=tQ(t.reverse(),e);return[n,r]}(t),a=r&&i;a?e.shiftKey||o!==i?e.shiftKey&&o===r&&(e.preventDefault(),n&&tY(i,{select:!0})):(e.preventDefault(),n&&tY(r,{select:!0})):o===t&&e.preventDefault()}},[n,r,p.paused]);return/*#__PURE__*/(0,y.createElement)(z.div,k({tabIndex:-1},a,{ref:f,onKeyDown:h}))});/**
...
,onFocusOutside:E(e.onFocusOutside,e=>e.preventDefault())}))}),nQ=/*#__PURE__*/(0,y.forwardRef)((e,t)=>{let n=nF(nG,e.__scopeDialog),r=(0,y.useRef)(!1),o=(0,y.useRef)(!1);return/*#__PURE__*/(0,y.createElement)(nY,k({},e,{ref:t,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:t=>{var i,a;null===(i=e.onCloseAutoFocus)||void 0===i||i.call(e,t),t.defaultPrevented||(r.current||null===(a=n.triggerRef.current)||void 0===a||a.focus(),t.preventDefault()),r.current=!1,o.current=!1},onInteractOutside:t=>{var i,a;null===(i=e.onInteractOutside)||void 0===i||i.call(e,t),t.defaultPrevented||(r.current=!0,"pointerdown"!==t.detail.originalEvent.type||(o.current=!0));// As the trigger is already setup to close, without doing so would
...
var iC=(e,t,n)=>{if(oQ.fun(e))return e;if(oQ.arr(e))return iC({range:e,output:t,extrapolate:n});if(oQ.str(e.output[0]))return u7(e);let r=e.output,o=e.range||[0,1],i=e.extrapolateLeft||e.extrapolate||"extend",a=e.extrapolateRight||e.extrapolate||"extend",l=e.easing||(e=>e);return t=>{let n=function(e,t){for(var n=1;n<t.length-1&&!(t[n]>=e);++n);return n-1}(t,o);return function(e,t,n,r,o,i,a,l,s){let u=s?s(e):e;if(u<t){if("identity"===a)return u;"clamp"===a&&(u=t)}if(u>n){if("identity"===l)return u;"clamp"===l&&(u=n)}return r===o?r:t===n?e<=t?r:o:(t===-1/0?u=-u:n===1/0?u-=t:u=(u-t)/(n-t),u=i(u),r===-1/0?u=-u:o===1/0?u+=r:u=u*(o-r)+r,u)}(t,o[n],o[n+1],r[n],r[n+1],l,i,a,e.map)}},i_=Symbol.for("FluidValue.get"),iP=Symbol.for("FluidValue.observers"),iT=e=>!!(e&&e[i_]),iN=e=>e&&e[i_]?e[i_]():e,iO=e=>e[iP]||null;function iA(e,t){let n=e[iP];n&&n.forEach(e=>{e.eventObserved?e.eventObserved(t):e(t)})}var ij=class{constructor(e){if(!e&&!(e=this.get))throw Error("Unknown getter");iI(this,e)}},iI=(e,t)=>iz(e,i_,t);function iD(e,t){if(e[i_]){let n=e[iP];n||iz(e,iP,n=/* @__PURE__ */new Set),!n.has(t)&&(n.add(t),e.observerAdded&&e.observerAdded(n.size,t))}return t}function iM(e,t){let n=e[iP];if(n&&n.has(t)){let r=n.size-1;r?n.delete(t):e[iP]=null,e.observerRemoved&&e.observerRemoved(r,t)}}var iz=(e,t,n)=>Object.defineProperty(e,t,{value:n,writable:!0,configurable:!0}),iF=/[+\-]?(?:0|[1-9]\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,iL=/(#(?:[0-9a-f]{2}){2,4}|(#[0-9a-f]{3})|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))/gi,i$=RegExp(`(${iF.source})(%|[a-z]+)`,"i"),iU=/rgba\(([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+), ([0-9\.-]+)\)/gi,iV=/var\((--[a-zA-Z0-9-_]+),? ?([a-zA-Z0-9 ()%#.,-]+)?\)/,iW=e=>{let[t,n]=iH(e);if(!t||o2())return e;let r=window.getComputedStyle(document.documentElement).getPropertyValue(t);if(r)return r.trim();if(n&&n.startsWith("--")){let e=window.getComputedStyle(document.documentElement).getPropertyValue(n);if(e)return e}else if(n&&iV.test(n))return iW(n);else if(n)return n;return e},iH=e=>{let t=iV.exec(e);if(!t)return[,];let[,n,r]=t;return[n,r]},iB=(e,t,n,r,o)=>`rgba(${Math.round(t)}, ${Math.round(n)}, ${Math.round(r)}, ${o})`,iG=e=>{ct||(ct=o3?RegExp(`(${Object.keys(o3).join("|")})(?!\\w)`,"g"):/^\b$/);let t=e.output.map(e=>iN(e).replace(iV,iW).replace(iL,iR).replace(ct,iR)),n=t.map(e=>e.match(iF).map(Number)),r=n[0].map((e,t)=>n.map(e=>{if(!(t in e))throw Error('The arity of each "output" value must be equal');return e[t]})),o=r.map(t=>iC({...e,output:t}));return e=>{let n=!i$.test(t[0])&&t.find(e=>i$.test(e))?.replace(iF,""),r=0;return t[0].replace(iF,()=>`${o[r++](e)}${n||""}`).replace(iU,iB)}},iq="react-spring: ",iK=e=>{let t=!1;if("function"!=typeof e)throw TypeError(`${iq}once requires a function parameter`);return(...n)=>{t||(e(...n),t=!0)}},iQ=iK(console.warn),iY=iK(console.warn);// src/isAnimatedString.ts
...
var aS={tension:170,friction:26,mass:1,damping:1,easing:e=>e,clamp:!1},ak=class{constructor(){/**
     ...
     *
     * @default 0
     */this.velocity=0,Object.assign(this,aS)}};function aE(e,t){if(oQ.und(t.decay)){let n=!oQ.und(t.tension)||!oQ.und(t.friction);!n&&oQ.und(t.frequency)&&oQ.und(t.damping)&&oQ.und(t.mass)||(e.duration=void 0,e.decay=void 0),n&&(e.frequency=void 0)}else e.duration=void 0}// src/Animation.ts
...
o!==n.asyncId&&aN(r,!1);if(t)throw e.result=t,c(e),e},m=(e,t)=>{let i=new aI,a=new aD;return(async()=>{if(oP.skipAnimation)throw aj(n),a.result=aN(r,!1),c(a),a;h(i);let l=oQ.obj(e)?{...e}:{...t,to:e};l.parentId=o,oZ(f,(e,t)=>{oQ.und(l[t])&&(l[t]=e)});let s=await r.start(l);return h(i),n.paused&&await new Promise(e=>{n.resumeQueue.add(e)}),s})()};if(oP.skipAnimation)return aj(n),aN(r,!1);try{let t;t=oQ.arr(e)?(async e=>{for(let t of e)await m(t)})(e):Promise.resolve(e(m,r.stop.bind(r))),await Promise.all([t.then(u),p]),d=aN(r.get(),!0,!1)}catch(e){if(e instanceof aI)d=e.result;else if(e instanceof aD)d=e.result;else throw e}finally{o==n.asyncId&&(n.asyncId=i,n.asyncTo=i?l:void 0,n.promise=i?s:void 0)}return oQ.fun(a)&&oN.batchedUpdates(()=>{a(d,r,r.item)}),d})():s}function aj(e,t){o0(e.timeouts,e=>e.cancel()),e.pauseQueue.clear(),e.resumeQueue.clear(),e.asyncId=e.asyncTo=e.promise=void 0,t&&(e.cancelId=t)}var aI=class extends Error{constructor(){super("An async animation has been interrupted. You see this error because you forgot to use `await` or `.catch(...)` on its returned promise.")}},aD=class extends Error{constructor(){super("SkipAnimationSignal")}},aM=e=>e instanceof aF,az=1,aF=class extends ij{constructor(){super(...arguments),this.id=az++,this._priority=0}get priority(){return this._priority}set priority(e){this._priority!=e&&(this._priority=e,this._onPriorityChange(e))}/** Get the current value */get(){let e=i6(this);return e&&e.getValue()}/** Create a spring that maps our value to another value */to(...e){return oP.to(this,e)}/** @deprecated Use the `to` method instead. */interpolate(...e){return iQ(`${iq}The "interpolate" function is deprecated in v9 (use "to" instead)`),oP.to(this,e)}toJSON(){return this.get()}observerAdded(e){1==e&&this._attach()}observerRemoved(e){0==e&&this._detach()}/** Called when the first child is added. */_attach(){}/** Called when the last child is removed. */_detach(){}/** Tell our children about our new value */_onChange(e,t=!1){iA(this,{type:"change",parent:this,value:e,idle:t})}/** Tell our children about our new priority */_onPriorityChange(e){this.idle||it.sort(this),iA(this,{type:"priority",parent:this,priority:e})}},aL=Symbol.for("SpringPhase"),a$=e=>(1&e[aL])>0,aU=e=>(2&e[aL])>0,aV=e=>(4&e[aL])>0,aW=(e,t)=>t?e[aL]|=3:e[aL]&=-3,aH=(e,t)=>t?e[aL]|=4:e[aL]&=-5,aB=class extends aF{constructor(e,t){if(super(),/** The animation state */this.animation=new aC,/** Some props have customizable default values */this.defaultProps={},/** The state for `runAsync` calls */this._state={paused:!1,delayed:!1,pauseQueue:/* @__PURE__ */new Set,resumeQueue:/* @__PURE__ */new Set,timeouts:/* @__PURE__ */new Set},/** The promise resolvers of pending `start` calls */this._pendingCalls=/* @__PURE__ */new Set,/** The counter for tracking `scheduleProps` calls */this._lastCallId=0,/** The last `scheduleProps` call that changed the `to` prop */this._lastToId=0,this._memoizedDuration=0,!oQ.und(e)||!oQ.und(t)){let n=oQ.obj(e)?{...e}:{...t,from:e};oQ.und(n.default)&&(n.default=!0),this.start(n)}}/** Equals true when not advancing on each frame. */get idle(){return!(aU(this)||this._state.asyncTo)||aV(this)}get goal(){return iN(this.animation.to)}get velocity(){let e=i6(this);return e instanceof ae?e.lastVelocity||0:e.getPayload().map(e=>e.lastVelocity||0)}/**
   ...
   */_prepareNode(e){let t=this.key||"",{to:n,from:r}=e;(null==(n=oQ.obj(n)?n[t]:n)||ax(n))&&(n=void 0),null==(r=oQ.obj(r)?r[t]:r)&&(r=void 0);let o={to:n,from:r};return a$(this)||(e.reverse&&([n,r]=[r,n]),r=iN(r),oQ.und(r)?i6(this)||this._set(n):this._set(r)),o}/** Every update is processed by this method before merging. */_update({...e},t){let{key:n,defaultProps:r}=this;e.default&&Object.assign(r,ag(e,(e,t)=>/^on/.test(t)?ap(e,n):e)),aX(this,e,"onProps"),aZ(this,"onProps",e,this);let o=this._prepareNode(e);if(Object.isFrozen(this))throw Error("Cannot animate a `SpringValue` object that is frozen. Did you forget to pass your component to `animated(...)` before animating its props?");let i=this._state;return a_(++this._lastCallId,{key:n,props:e,defaultProps:r,state:i,actions:{pause:()=>{aV(this)||(aH(this,!0),o1(i.pauseQueue),aZ(this,"onPause",aN(this,aG(this,this.animation.to)),this))},resume:()=>{aV(this)&&(aH(this,!1),aU(this)&&this._resume(),o1(i.resumeQueue),aZ(this,"onResume",aN(this,aG(this,this.animation.to)),this))},start:this._merge.bind(this,o)}}).then(n=>{if(e.loop&&n.finished&&!(t&&n.noop)){let t=aq(e);if(t)return this._update(t,!0)}return n})}/** Merge props into the current animation */_merge(e,t,n){if(t.cancel)return this.stop(!0),n(aO(this));let r=!oQ.und(e.to),o=!oQ.und(e.from);if(r||o){if(!(t.callId>this._lastToId))return n(aO(this));this._lastToId=t.callId}let{key:i,defaultProps:a,animation:l}=this,{to:s,from:u}=l,{to:c=s,from:d=u}=e;o&&!r&&(!t.default||oQ.und(c))&&(c=d),t.reverse&&([c,d]=[d,c]);let f=!oY(d,u);f&&(l.from=d),d=iN(d);let p=!oY(c,s);p&&this._focus(c);let h=ax(t.to),{config:m}=l,{decay:g,velocity:v}=m;(r||o)&&(m.velocity=0),t.config&&!h&&function(e,t,n){for(let r in n&&(aE(n={...n},t),t={...n,...t}),aE(e,t),Object.assign(e,t),aS)null==e[r]&&(e[r]=aS[r]);let{frequency:r,damping:o}=e,{mass:i}=e;oQ.und(r)||(r<.01&&(r=.01),o<0&&(o=0),e.tension=Math.pow(2*Math.PI/r,2)*i,e.friction=4*Math.PI*o*i/r)}(m,ad(t.config,i),t.config!==a.config?ad(a.config,i):void 0);let y=i6(this);if(!y||oQ.und(c))return n(aN(this,!0));let b=oQ.und(t.reset)?o&&!t.default:!oQ.und(d)&&af(t.reset,i),w=b?d:this.get(),x=aw(c),S=oQ.num(x)||oQ.arr(x)||iX(x),k=!h&&(!S||af(a.immediate||t.immediate,i));if(p){let e=aa(c);if(e!==y.constructor){if(k)y=this._set(x);else throw Error(`Cannot animate between ${y.constructor.name} and ${e.name}, as the "to" prop suggests`)}}let E=y.constructor,R=iT(c),C=!1;if(!R){let e=b||!a$(this)&&f;(p||e)&&(R=!(C=oY(aw(w),x))),(oY(l.immediate,k)||k)&&oY(m.decay,g)&&oY(m.velocity,v)||(R=!0)}if(C&&aU(this)&&(l.changed&&!b?R=!0:R||this._stop(s)),!h&&((R||iT(s))&&(l.values=y.getPayload(),l.toValues=iT(c)?null:E==at?[1]:oJ(x)),l.immediate==k||(l.immediate=k,k||b||this._set(s)),R)){let{onRest:e}=l;oX(aY,e=>aX(this,t,e));let r=aN(this,aG(this,s));o1(this._pendingCalls,r),this._pendingCalls.add(n),l.changed&&oN.batchedUpdates(()=>{l.changed=!b,e?.(r,this),b?ad(a.onRest,r):l.onStart?.(r,this)})}b&&this._set(w),h?n(aA(t.to,t,this._state,this)):R?this._start():aU(this)&&!p?this._pendingCalls.add(n):n(aT(w))}/** Update the `animation.to` value, which might be a `FluidValue` */_focus(e){let t=this.animation;e!==t.to&&(iO(this)&&this._detach(),t.to=e,iO(this)&&this._attach())}_attach(){let e=0,{to:t}=this.animation;iT(t)&&(iD(t,this),aM(t)&&(e=t.priority+1)),this.priority=e}_detach(){let{to:e}=this.animation;iT(e)&&iM(e,this)}/**
...
_start(){let e=this.animation;i6(this).reset(iN(e.to)),e.immediate||(e.fromValues=e.values.map(e=>e.lastPosition)),aU(this)||(aW(this,!0),aV(this)||this._resume())}_resume(){oP.skipAnimation?this.finish():it.start(this)}/**
   ...
   */_stop(e,t){if(aU(this)){aW(this,!1);let n=this.animation;oX(n.values,e=>{e.done=!0}),n.toValues&&(n.onChange=n.onPause=n.onResume=void 0),iA(this,{type:"idle",parent:this});let r=t?aO(this.get()):aN(this.get(),aG(this,e??n.to));o1(this._pendingCalls,r),n.changed&&(n.changed=!1,aZ(this,"onRest",r,this))}}};function aG(e,t){let n=aw(t),r=aw(e.get());return oY(r,n)}function aq(e,t=e.loop,n=e.to){let r=ad(t);if(r){let o=!0!==r&&ab(r),i=(o||e).reverse,a=!o||o.reset;return aK({...e,loop:t,// Avoid updating default props when looping.
...
fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},lu=(e,t)=>e+t.charAt(0).toUpperCase()+t.substring(1),lc=["Webkit","Ms","Moz","O"];ls=Object.keys(ls).reduce((e,t)=>(lc.forEach(n=>e[lu(n,t)]=e[t]),e),ls);var ld=/^(matrix|translate|scale|rotate|skew)/,lf=/^(translate)/,lp=/^(rotate|skew)/,lh=(e,t)=>oQ.num(e)&&0!==e?e+t:e,lm=(e,t)=>oQ.arr(e)?e.every(e=>lm(e,t)):oQ.num(e)?e===t:parseFloat(e)===t,lg=class extends ar{constructor({x:e,y:t,z:n,...r}){let o=[],i=[];(e||t||n)&&(o.push([e||0,t||0,n||0]),i.push(e=>[`translate3d(${e.map(e=>lh(e,"px")).join(",")})`,// prettier-ignore
    lm(e,0)])),oZ(r,(e,t)=>{if("transform"===t)o.push([e||""]),i.push(e=>[e,""===e]);else if(ld.test(t)){if(delete r[t],oQ.und(e))return;let n=lf.test(t)?"px":lp.test(t)?"deg":"";o.push(oJ(e)),i.push("rotate3d"===t?([e,t,r,o])=>[`rotate3d(${e},${t},${r},${lh(o,n)})`,lm(o,0)]:e=>[`${t}(${e.map(e=>lh(e,n)).join(",")})`,lm(e,t.startsWith("scale")?1:0)])}}),o.length&&(r.transform=new lv(o,i)),super(r)}},lv=class extends ij{constructor(e,t){super(),this.inputs=e,this.transforms=t,this._value=null}get(){return this._value||(this._value=this._get())}_get(){let e="",t=!0;return oX(this.inputs,(n,r)=>{let o=iN(n[0]),[i,a]=this.transforms[r](oQ.arr(o)?o:n.map(iN));e+=" "+i,t=t&&a}),t?"none":e}// Start observing our inputs once we have an observer.
...
r=e.offsetWidth,o=e.offsetHeight;n({width:r,height:o})});return t.observe(e,{box:"border-box"}),()=>t.unobserve(e)}n(void 0)},[e]),t}(U),H=null!==(n=null==W?void 0:W.width)&&void 0!==n?n:0,B=null!==(r=null==W?void 0:W.height)&&void 0!==r?r:0,G="number"==typeof P?P:{top:0,right:0,bottom:0,left:0,...P},q=Array.isArray(C)?C:[C],K=q.length>0,Q={padding:G,boundary:q.filter(sC),// with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
...
if(!n)switch(g){case"bestFit":{let e=null==(i=_.map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:i[0];e&&(n=e);break}case"initialPlacement":n=u}if(a!==n)return{reset:{placement:n}}}return{}}},{name:"size",options:h={...Q,apply:({elements:e,rects:t,availableWidth:n,availableHeight:r})=>{let{width:o,height:i}=t.reference,a=e.floating.style;a.setProperty("--radix-popper-available-width",`${n}px`),a.setProperty("--radix-popper-available-height",`${r}px`),a.setProperty("--radix-popper-anchor-width",`${o}px`),a.setProperty("--radix-popper-anchor-height",`${i}px`)}},async fn(e){let t,n;let{placement:r,rects:o,platform:i,elements:a}=e,{apply:l=()=>{},...s}=l_(h,e),u=await lL(e,s),c=lP(r),d=lT(r),f="y"===lA(r),{width:p,height:m}=o.floating;"top"===c||"bottom"===c?(t=c,n=d===(await (null==i.isRTL?void 0:i.isRTL(a.floating))?"start":"end")?"left":"right"):(n=c,t="end"===d?"top":"bottom");let g=m-u[t],v=p-u[n],y=!e.middlewareData.shift,b=g,w=v;if(f){let e=p-u.left-u.right;w=d||y?lw(v,e):e}else{let e=m-u.top-u.bottom;b=d||y?lw(g,e):e}if(y&&!d){let e=lx(u.left,0),t=lx(u.right,0),n=lx(u.top,0),r=lx(u.bottom,0);f?w=p-2*(0!==e||0!==t?e+t:lx(u.left,u.right)):b=m-2*(0!==n||0!==r?n+r:lx(u.top,u.bottom))}await l({...e,availableWidth:w,availableHeight:b});let x=await i.getDimensions(a.floating);return p!==x.width||m!==x.height?{reset:{rects:!0}}:{}}},U&&ss({element:U,padding:E}),s_({arrowWidth:H,arrowHeight:B}),N&&{name:"hide",options:m={strategy:"referenceHidden",...Q},async fn(e){let{rects:t}=e,{strategy:n="referenceHidden",...r}=l_(m,e);switch(n){case"referenceHidden":{let n=await lL(e,{...r,elementContext:"reference"}),o=lU(n,t.reference);return{data:{referenceHiddenOffsets:o,referenceHidden:lV(o)}}}case"escaped":{let n=await lL(e,{...r,altBoundary:!0}),o=lU(n,t.floating);return{data:{escapedOffsets:o,escaped:lV(o)}}}default:return{}}}}]}),[et,en]=sP(Z),er=L(A);j(()=>{J&&(null==er||er())},[J,er]);let eo=null===(o=ee.arrow)||void 0===o?void 0:o.x,ei=null===(i=ee.arrow)||void 0===i?void 0:i.y,ea=(null===(a=ee.arrow)||void 0===a?void 0:a.centerOffset)!==0,[el,es]=(0,y.useState)();return j(()=>{M&&es(window.getComputedStyle(M).zIndex)},[M]),/*#__PURE__*/(0,y.createElement)("div",{ref:Y.setFloating,"data-radix-popper-content-wrapper":"",style:{...X,transform:J?X.transform:"translate(0, -200%)",// keep off the page when measuring
...
f$.isMemo(e)?fW:fH[e.$$typeof]||fU)}fH[f$.ForwardRef]={$$typeof:!0,render:!0,defaultProps:!0,displayName:!0,propTypes:!0},fH[f$.Memo]=fW;var fG=Object.defineProperty,fq=Object.getOwnPropertyNames,fK=Object.getOwnPropertySymbols,fQ=Object.getOwnPropertyDescriptor,fY=Object.getPrototypeOf,fX=Object.prototype;fL=function e(t,n,r){if("string"!=typeof n){// don't hoist over string (html) components
if(fX){var o=fY(n);o&&o!==fX&&e(t,o,r)}var i=fq(n);fK&&(i=i.concat(fK(n)));for(var a=fB(t),l=fB(n),s=0;s<i.length;++s){var u=i[s];if(!fV[u]&&!(r&&r[u])&&!(l&&l[u])&&!(a&&a[u])){var c=fQ(n,u);try{// Avoid failures from read-only properties
...
var hF={Moz:"-moz-",ms:"-ms-",O:"-o-",Webkit:"-webkit-"},hL=document.createElement("p").style;for(var h$ in hF)if(h$+"Transform" in hL){hj=h$,hI=hF[h$];break}"Webkit"===hj&&"msHyphens"in hL&&(hj="ms",hI=hF.ms,hM="edge"),"Webkit"===hj&&"-apple-trailing-word"in hL&&(hD="apple")}/**
...
mH.prototype.clear=mz,mH.prototype.delete=mF,mH.prototype.get=mU,mH.prototype.has=mV,mH.prototype.set=mW,mM=mH;var mB={};mB=/**
...
gb.prototype.clear=mB,gb.prototype.delete=mG,gb.prototype.get=mq,gb.prototype.has=mK,gb.prototype.set=mQ,mD=gb;var gw={},gx={},gS={};gS=/**
 ...
 */function(e,t,n){var r=t(e);return mC(e)?r:gM(r,n(e))};var gz={},gF={};gF=/**
 ...
 */function(e,t){var n=mC(e),r=!n&&gB(e),o=!n&&!r&&gY(e),i=!n&&!r&&!o&&gX(e),a=n||r||o||i,l=a?gH(e.length,String):[],s=l.length;for(var u in e)(t||g3.call(e,u))&&!(a&&// Safari 9 has enumerable `arguments.length` in strict mode.
