...
function sq(e,t){let n=sE(e);if(!sP(e))return n;let r=sB(e,t);for(;r&&["table","td","th"].includes(sk(r))&&"static"===sI(r).position;)r=sB(r,t);return r&&("html"===sk(r)||"body"===sk(r)&&"static"===sI(r).position&&!sO(r))?n:r||function(e){let t=sM(e);for(;sP(t)&&!sj(t);){if(sO(t))return t;t=sM(t)}return null}(e)||n}const sY=async function(e){let{reference:t,floating:n,strategy:r}=e,o=this.getOffsetParent||sq,i=this.getDimensions;return{reference:function(e,t,n){let r=sP(t),o=sC(t),i="fixed"===n,a=sV(e,!0,i,t),l={scrollLeft:0,scrollTop:0},s=sr(0);if(r||!r&&!i){if(("body"!==sk(t)||sN(o))&&(l=sD(t)),r){let e=sV(t,!0,i,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&(s.x=sH(o))}return{x:a.left+l.scrollLeft-s.x,y:a.top+l.scrollTop-s.y,width:a.width,height:a.height}}(t,await o(n),r),floating:{x:0,y:0,...await i(n)}}},sK={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:n,strategy:r}=e,o=sP(n),i=sC(n);if(n===i)return t;let a={scrollLeft:0,scrollTop:0},l=sr(1),s=sr(0);if((o||!o&&"fixed"!==r)&&(("body"!==sk(n)||sN(i))&&(a=sD(n)),sP(n))){let e=sV(n);l=sU(n),s.x=e.x+n.clientLeft,s.y=e.y+n.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-a.scrollLeft*l.x+s.x,y:t.y*l.y-a.scrollTop*l.y+s.y}},getDocumentElement:sC,getClippingRect:// Gets the maximum area that the element is visible in due to any number of
// clipping ancestors.
...
i.onAnchorChange((null==r?void 0:r.current)||a.current)}),r?null:/*#__PURE__*/(0,b.createElement)(L.div,E({},o,{ref:l}))}),ue="PopperContent",[ut,un]=s6(ue),ur=/*#__PURE__*/(0,b.forwardRef)((e,t)=>{var n,r,o,i,a,l,s,u,c,d,f,p,h,m;let{__scopePopper:g,side:y="bottom",sideOffset:w=0,align:x="center",alignOffset:S=0,arrowPadding:k=0,avoidCollisions:C=!0,collisionBoundary:R=[],collisionPadding:T=0,sticky:_="partial",hideWhenDetached:N=!1,updatePositionStrategy:O="optimized",onPlaced:A,...j}=e,D=s8(ue,g),[M,z]=(0,b.useState)(null),F=P(t,e=>z(e)),[$,W]=(0,b.useState)(null),V=function(e){let[t,n]=(0,b.useState)(void 0);return I(()=>{if(e){// provide size as early as possible
...
r=e.offsetWidth,o=e.offsetHeight;n({width:r,height:o})});return t.observe(e,{box:"border-box"}),()=>t.unobserve(e)}n(void 0)},[e]),t}($),H=null!==(n=null==V?void 0:V.width)&&void 0!==n?n:0,G=null!==(r=null==V?void 0:V.height)&&void 0!==r?r:0,B="number"==typeof T?T:{top:0,right:0,bottom:0,left:0,...T},q=Array.isArray(R)?R:[R],Y=q.length>0,K={padding:B,boundary:q.filter(ui),// with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
...
return cH.call(this,e,0)}}}!function(){try{cH="function"==typeof setTimeout?setTimeout:cd}catch(e){cH=cd}try{cG="function"==typeof clearTimeout?clearTimeout:cf}catch(e){cG=cf}}();var ch=[],cm=!1,cg=-1;function cv(){cm&&cB&&(cm=!1,cB.length?ch=cB.concat(ch):cg=-1,ch.length&&cy())}function cy(){if(!cm){var e=cp(cv);cm=!0;for(var t=ch.length;t;){for(cB=ch,ch=[];++cg<t;)cB&&cB[cg].run();cg=-1,t=ch.length}cB=null,cm=!1,function(e){if(cG===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
 ...
 * _.toFinite('3.2');
 * // => 3.2
 */function(e){return e?(e=pr(e))===pm||e===-pm?(e<0?-1:1)*17976931348623157e292:e==e?e:0:0===e?e:0},fV=function(e,t,n){return n&&"number"!=typeof n&&fq(e,t,n)&&(t=n=void 0),// Ensure the sign of `-0` is preserved.
e=pn(e),void 0===t?(t=e,e=0):t=pn(t),n=void 0===n?e<t?1:-1:pn(n),fH(e,t,n,void 0)};var b=m("bh6RR"),pv={},py={};py=m("g4WQO");/**
...
if(void 0===t&&(t={}),void 0===n&&(n={}),"object"==typeof e)return this.createRule(void 0,e,t);var r=E({},n,{name:e,jss:this,Renderer:this.options.Renderer});r.generateId||(r.generateId=this.generateId),r.classes||(r.classes={}),r.keyframes||(r.keyframes={});var o=pG(e,t,r);return o&&this.plugins.onProcessRule(o),o}/**
   ...
   */,t.indexOf=function(e){return this.rules.indexOf(e)}/**
   * Generates a CSS string.
   */,t.toString=function(e){return this.rules.toString(e)},e}(),hq=/*#__PURE__*/function(){function e(e,t,n){this.type="global",this.at=hH,this.isProcessed=!1,this.key=e,this.options=n;var r=e.substr(hG.length);this.rule=n.jss.createRule(r,t,E({},n,{parent:this}))}return e.prototype.toString=function(e){return this.rule?this.rule.toString(e):""},e}(),hY=/\s*,\s*/g;function hK(e,t){for(var n=e.split(hY),r="",o=0;o<n.length;o++)r+=t+" "+n[o].trim(),n[o+1]&&(r+=", ");return r}var hQ=function(e){return e&&"object"==typeof e&&!Array.isArray(e)},hX="extendCurrValue"+Date.now(),hJ=/\s*,\s*/g,hZ=/&/g,h0=/\$([\w-]+)/g,h1=/[A-Z]/g,h2=/^ms-/,h3={};function h4(e){return"-"+e.toLowerCase()}var h6=function(e){if(h3.hasOwnProperty(e))return h3[e];var t=e.replace(h1,h4);return h3[e]=h2.test(t)?"-"+t:t};/**
...
}},onProcessStyle:function(e,t){return"style"!==t.type?e:function e(t){for(var n in t){var r=t[n];if("fallbacks"===n&&Array.isArray(r)){t[n]=r.map(e);continue}var o=!1,i=mI(n);i&&i!==n&&(o=!0);var a=!1,l=mF(i,pq(r));l&&l!==r&&(a=!0),(o||a)&&(o&&delete t[n],t[i||n]=l||r)}return t}(e)},onChangeValue:function(e,t){return mF(t,pq(e))||e}},mU()]}},mW=hj(m$()),mV=function(e){void 0===e&&(e=mW);var t,n=new Map,r=0,o=function(){return(!t||t.rules.index.length>1e4)&&(t=e.createStyleSheet().attach()),t};function i(){// eslint-disable-next-line prefer-rest-params
...
return i.getSheet=o,i}(),mH=Number.MIN_SAFE_INTEGER||-1e9,mG=(0,b.createContext)({classNamePrefix:"",disableStylesGeneration:!1,isSSR:!pz}),mB=new Map,mq=function(e,t){// If `managers` map is present in the context, we use it in order to
 ...
 */function(e,t){var n=g$(e,t);return gN(n)?n:void 0};var fZ=m("dnnhb");gP=g_(fZ,"Map");var gW={},gV={},gH={},gG={},gB={};gB=g_(Object,"create"),gG=/**
...
gZ.prototype.clear=gG,gZ.prototype.delete=gq,gZ.prototype.get=gY,gZ.prototype.has=gQ,gZ.prototype.set=gJ,gH=gZ,gV=/**
 * Removes all key-value entries from the map.
 *
 * @private
 * @name clear
 * @memberOf MapCache
 */function(){this.size=0,this.__data__={hash:new gH,map:new(gP||gh),string:new gH}};var g0={},g1={},g2={};g2=/**
...
g5.prototype.clear=gV,g5.prototype.delete=g0,g5.prototype.get=g3,g5.prototype.has=g4,g5.prototype.set=g6,gW=g5,gT=/**
