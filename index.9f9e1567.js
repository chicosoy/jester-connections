 ...
 */function(e){let t=tQ(e),n=tK(t,e),r=tK(t.reverse(),e);return[n,r]}(t),a=r&&i;a?e.shiftKey||o!==i?e.shiftKey&&o===r&&(e.preventDefault(),n&&tY(i,{select:!0})):(e.preventDefault(),n&&tY(r,{select:!0})):o===t&&e.preventDefault()}},[n,r,p.paused]);return/*#__PURE__*/(0,y.createElement)(z.div,S({tabIndex:-1},a,{ref:f,onKeyDown:h}))});/**
...
function(e,t){let n=se(e,!0,"fixed"===t),r=n.top+e.clientTop,o=n.left+e.clientLeft,i=lK(e)?l9(e):lE(1),a=e.clientWidth*i.x,l=e.clientHeight*i.y,s=o*i.x,u=r*i.y;return{width:a,height:l,x:s,y:u}}(t,n);else{let n=l7(e);r={...t,x:t.x-n.x,y:t.y-n.y}}return lM(r)}function sr(e,t){return lK(e)&&"fixed"!==l1(e).position?t?t(e):e.offsetParent:null}// Gets the closest ancestor positioned element. Handles some edge cases,
