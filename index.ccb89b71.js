...
console.warn(Error().stack)),new Date(NaN)))}function rz(e,t){rI(2,arguments);var n=rD(e),r=rj(t);return isNaN(r)?new Date(NaN):(r&&n.setDate(n.getDate()+r),n)}/**
 ...
 */function rF(e){var t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds()));return t.setUTCFullYear(e.getFullYear()),e.getTime()-t.getTime()}function rL(e){rI(1,arguments);var t=rD(e);return t.setHours(0,0,0,0),t}// for accurate equality comparisons of UTC timestamps that end up
