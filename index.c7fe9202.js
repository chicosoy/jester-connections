...
function sB(e,t){let n=sE(e);if(!s_(e))return n;let r=sY(e,t);for(;r&&["table","td","th"].includes(sk(r))&&"static"===sj(r).position;)r=sY(r,t);return r&&("html"===sk(r)||"body"===sk(r)&&"static"===sj(r).position&&!sO(r))?n:r||function(e){let t=sD(e);for(;s_(t)&&!sM(t);){if(sO(t))return t;t=sD(t)}return null}(e)||n}let sq=async function(e){let{reference:t,floating:n,strategy:r}=e,o=this.getOffsetParent||sB,i=this.getDimensions;return{reference:function(e,t,n){let r=s_(t),o=sC(t),i="fixed"===n,a=sH(e,!0,i,t),l={scrollLeft:0,scrollTop:0},s=sr(0);if(r||!r&&!i){if(("body"!==sk(t)||sR(o))&&(l=sI(t)),r){let e=sH(t,!0,i,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&(s.x=sV(o))}return{x:a.left+l.scrollLeft-s.x,y:a.top+l.scrollTop-s.y,width:a.width,height:a.height}}(t,await o(n),r),floating:{x:0,y:0,...await i(n)}}},sK={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:n,strategy:r}=e,o=s_(n),i=sC(n);if(n===i)return t;let a={scrollLeft:0,scrollTop:0},l=sr(1),s=sr(0);if((o||!o&&"fixed"!==r)&&(("body"!==sk(n)||sR(i))&&(a=sI(n)),s_(n))){let e=sH(n);l=sU(n),s.x=e.x+n.clientLeft,s.y=e.y+n.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-a.scrollLeft*l.x+s.x,y:t.y*l.y-a.scrollTop*l.y+s.y}},getDocumentElement:sC,getClippingRect:// Gets the maximum area that the element is visible in due to any number of
// clipping ancestors.
...
return cV.call(this,e,0)}}}!function(){try{cV="function"==typeof setTimeout?setTimeout:cd}catch(e){cV=cd}try{cG="function"==typeof clearTimeout?clearTimeout:cf}catch(e){cG=cf}}();var ch=[],cm=!1,cg=-1;function cv(){cm&&cY&&(cm=!1,cY.length?ch=cY.concat(ch):cg=-1,ch.length&&cy())}function cy(){if(!cm){var e=cp(cv);cm=!0;for(var t=ch.length;t;){for(cY=ch,ch=[];++cg<t;)cY&&cY[cg].run();cg=-1,t=ch.length}cY=null,cm=!1,function(e){if(cG===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
 ...
 * _.toFinite('3.2');
 * // => 3.2
 */function(e){return e?(e=pr(e))===pm||e===-pm?(e<0?-1:1)*17976931348623157e292:e==e?e:0:0===e?e:0},fH=function(e,t,n){return n&&"number"!=typeof n&&fB(e,t,n)&&(t=n=void 0),// Ensure the sign of `-0` is preserved.
e=pn(e),void 0===t?(t=e,e=0):t=pn(t),n=void 0===n?e<t?1:-1:pn(n),fV(e,t,n,void 0)};var b=m("exYeM"),pv={},py={};py=m("beWdq");/**
...
if(void 0===t&&(t={}),void 0===n&&(n={}),"object"==typeof e)return this.createRule(void 0,e,t);var r=E({},n,{name:e,jss:this,Renderer:this.options.Renderer});r.generateId||(r.generateId=this.generateId),r.classes||(r.classes={}),r.keyframes||(r.keyframes={});var o=pG(e,t,r);return o&&this.plugins.onProcessRule(o),o}/**
   ...
   */,t.indexOf=function(e){return this.rules.indexOf(e)}/**
   * Generates a CSS string.
   */,t.toString=function(e){return this.rules.toString(e)},e}(),hB=/*#__PURE__*/function(){function e(e,t,n){this.type="global",this.at=hV,this.isProcessed=!1,this.key=e,this.options=n;var r=e.substr(hG.length);this.rule=n.jss.createRule(r,t,E({},n,{parent:this}))}return e.prototype.toString=function(e){return this.rule?this.rule.toString(e):""},e}(),hq=/\s*,\s*/g;function hK(e,t){for(var n=e.split(hq),r="",o=0;o<n.length;o++)r+=t+" "+n[o].trim(),n[o+1]&&(r+=", ");return r}var hQ=function(e){return e&&"object"==typeof e&&!Array.isArray(e)},hX="extendCurrValue"+Date.now(),hJ=/\s*,\s*/g,hZ=/&/g,h0=/\$([\w-]+)/g,h1=/[A-Z]/g,h2=/^ms-/,h3={};function h4(e){return"-"+e.toLowerCase()}var h5=function(e){if(h3.hasOwnProperty(e))return h3[e];var t=e.replace(h1,h4);return h3[e]=h2.test(t)?"-"+t:t};/**
...
}},onProcessStyle:function(e,t){return"style"!==t.type?e:function e(t){for(var n in t){var r=t[n];if("fallbacks"===n&&Array.isArray(r)){t[n]=r.map(e);continue}var o=!1,i=mj(n);i&&i!==n&&(o=!0);var a=!1,l=mF(i,pB(r));l&&l!==r&&(a=!0),(o||a)&&(o&&delete t[n],t[i||n]=l||r)}return t}(e)},onChangeValue:function(e,t){return mF(t,pB(e))||e}},mU()]}},mW=hM(m$()),mH=function(e){void 0===e&&(e=mW);var t,n=new Map,r=0,o=function(){return(!t||t.rules.index.length>1e4)&&(t=e.createStyleSheet().attach()),t};function i(){// eslint-disable-next-line prefer-rest-params
...
return i.getSheet=o,i}(),mV=Number.MIN_SAFE_INTEGER||-1e9,mG=(0,b.createContext)({classNamePrefix:"",disableStylesGeneration:!1,isSSR:!pz}),mY=new Map,mB=function(e,t){// If `managers` map is present in the context, we use it in order to
 ...
 */function(e,t){var n=g$(e,t);return gR(n)?n:void 0};var fZ=m("8ThvE");g_=gN(fZ,"Map");var gW={},gH={},gV={},gG={},gY={};gY=gN(Object,"create"),gG=/**
...
gZ.prototype.clear=gG,gZ.prototype.delete=gB,gZ.prototype.get=gq,gZ.prototype.has=gQ,gZ.prototype.set=gJ,gV=gZ,gH=/**
 * Removes all key-value entries from the map.
 *
 * @private
 * @name clear
 * @memberOf MapCache
 */function(){this.size=0,this.__data__={hash:new gV,map:new(g_||gh),string:new gV}};var g0={},g1={},g2={};g2=/**
...
g6.prototype.clear=gH,g6.prototype.delete=g0,g6.prototype.get=g3,g6.prototype.has=g4,g6.prototype.set=g5,gW=g6,gP=/**
...
y!=b&&"constructor"in e&&"constructor"in t&&!("function"==typeof y&&y instanceof y&&"function"==typeof b&&b instanceof b)&&(p=!1)}return i.delete(e),i.delete(t),p};var vW={},vH={},fZ=m("8ThvE");vH=gN(fZ,"DataView");var vV={},fZ=m("8ThvE");vV=gN(fZ,"Promise");var vG={},fZ=m("8ThvE");vG=gN(fZ,"Set");var vY={},fZ=m("8ThvE");vY=gN(fZ,"WeakMap");/** `Object#toString` result references. */var vB="[object Map]",vq="[object Promise]",vK="[object Set]",vQ="[object WeakMap]",vX="[object DataView]",vJ=gj(vH),vZ=gj(g_),v0=gj(vV),v1=gj(vG),v2=gj(vY),v3=fX;(vH&&v3(new vH(new ArrayBuffer(1)))!=vX||g_&&v3(new g_)!=vB||vV&&v3(vV.resolve())!=vq||vG&&v3(new vG)!=vK||vY&&v3(new vY)!=vQ)&&(v3=function(e){var t=fX(e),n="[object Object]"==t?e.constructor:void 0,r=n?gj(n):"";if(r)switch(r){case vJ:return vX;case vZ:return vB;case v0:return vq;case v1:return vK;case v2:return vQ}return t}),vW=v3;var v_=m("7HKs8"),v4="[object Arguments]",v5="[object Array]",v6="[object Object]",v8=Object.prototype.hasOwnProperty;gf=/**
